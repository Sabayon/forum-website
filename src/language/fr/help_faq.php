...
*
* @package language
* @version $Id: help_faq.php 10341 2009-12-16 08:04:41Z rxu $
...
$help = array(
	...
	array(
		...
		1 => 'Soit l’administrateur n’a pas installé votre langue, soit personne n’a encore traduit phpBB dans votre langue. Essayez de demander à l’administrateur du forum s’il peut installer l’archive de langue que vous désirez. Si l’archive de langue n’existe pas, vous êtes libre de vous porter volontaire afin de créer une nouvelle traduction. Veuillez vous rendre sur le site de phpBB.com (accessible depuis le lien situé en bas de toutes les pages du forum) pour plus d’informations.'
	),
	array(
