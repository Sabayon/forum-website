...
*
* @package language
* @version $Id: board.php 10374 2009-12-23 03:26:38Z bantu $
...
$lang = array_merge($lang, array(
  ...
  'ACP_FEED_OVERALL_FORUMS_LIMIT'		=> 'Nombre d’objets par page à afficher dans le flux des forums', // DELETE

	'ACP_FEED_OVERALL_TOPIC'			=> 'Activer le flux des sujets',
	'ACP_FEED_OVERALL_TOPIC_EXPLAIN'	=> 'Active le flux de “tous les sujets”, qui affiche les derniers sujets créés incluant le premier message.',
  'ACP_FEED_OVERALL_TOPIC_LIMIT'		=> 'Nombre d’objets par page à afficher dans le flux des sujets', // DELETE
  ...
  'ACP_FEED_POST_BASED'				=> 'Réglages du flux lié aux messages',
	...
	'ACP_FEED_SETTINGS_OTHER'			=> 'Autres flux et réglages',
