...
$help = array(
	...
	array(
		...
		1 => 'Pot passar per diverses raons. Primer, assegureu-vos de que el vostre nom d’usuari i contrasenya són correctes. Si ho són, poseu-vos en contacte amb l’administrador del fòrum per assegurar-vos que no us han expulsat. També és possible que l’administrador del fòrum tingui un error de configuració que hagi d’arreglar.'
	),
	array(
	...
	array(
		...
		1 => 'Si no seleccioneu la casella <em>Inicia la sessió a cada visita automàticament</em> quan inicieu la sessió, el fòrum només mantindrà la sessió activa durant un període de temps predefinit. Això evita l’ús il·lícit del vostre compte per algú altre. Per mantenir la sessió activa, seleccioneu la casella en iniciar-la. Això no és recomanable si accediu al fòrum des d’un ordinador compartit p.ex. en una biblioteca, un cibercafè, una aula d’ordinadors a la universitat, etc. Si no podeu veure la casella, vol dir que l’administrador del fòrum ha inhabilitat aquesta funció.'
	),
	array(
		0 => 'Com evito que el meu nom d’usuari aparegui a la llista d’usuaris connectats?',
		1 => 'En el vostre Tauler de control de l’usuari, a “Preferències del fòrum”, hi trobareu l’opció <em>Oculta la meva presència quan estic connectat</em>. Activeu aquesta opció i només hi apareixereu per als administradors i el moderadors. Se us comptarà com a usuari ocult.'
	),
	array(
	...
	array(
		...
		1 => 'Intenteu trobar el correu electrònic que vau rebre quan us vau registrar, comproveu que el nom d’usuari i la contrasenya i torneu a intentar-ho. És possible que un administrador hagi desactivat o eliminat el vostre compte per alguna raó. També hi ha alguns fòrums que eliminen periòdicament els usuaris que no hagin publicat res en molt de temps per tal de reduir la mida de la base de dades. Si ha passat això, proveu de registrar-vos de nou i involucrar-vos més en les discussions del fòrum.'
	),
	array(
		0 => 'Què és el COPPA?',
		1 => 'COPPA són les sigles en anglès del Decret de protecció i privadesa en línia infantil (Child Online Privacy and Protection Act) del 1998. És una llei dels Estats Units que exigeix als llocs web que potencialment poden recollir dades de menors de 13 anys que obtinguin el consentiment escrit dels seus pares o d’un tutor legal per recollir dades personals identificables d’un menor de 13 anys. Si no esteu segur de si això us aplica com a persona que es registra o al lloc web en el qual voleu registrar-vos, busqueu assessorament legal. Tingueu en compte que el phpBB Group no us pot proporcionar assessorament legal i no és un punt de contacte per a dubtes legals de qualsevol tipus, a excepció dels descrits més avall.',
	),
	array(
		0 => 'Per què no em puc registrar?',
		1 => 'És possible que l’administrador del fòrum hagi bandejat la vostra adreça IP o hagi prohibit el nom d’usuari que esteu intentant registrar. L’administrador del fòrum pot haver inhabilitat el registre per evitar que visitants nous es pugin donar d’alta. Poseu-vos en contacte amb l’administrador del fòrum per rebre assistència.',
	),
	array(
		0 => 'Què fa l’opció “Elimina totes les galetes del fòrum”?',
		1 => '“Elimina totes les galetes del fòrum” elimina les galetes creades pel phpBB que us mantenen autenticat i amb la sessió iniciada al fòrum. També proporciona funcions com ara el seguiment dels temes llegits si l’administrador del fòrum les ha habilitat. Si experimenteu problemes d’inici i finalització de sessió, és possible que eliminar les galetes del fòrum ho solucioni.',
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Si sou un usuari registrat, totes les vostres configuracions s’emmagatzemen a la base de dades del fòrum. Per modificar-les, visiteu el Tauler de control de l’usuari a través de l’enllaç que trobareu habitualment a la part superior de les pàgines del fòrum. Aquest sistema us permet canviar totes les vostres configuracions i preferències.'
	),
	array(
		0 => 'Les hores són incorrectes!',
		1 => 'És possibble que els temps es mostrin en un fus horari diferent del vostre. Si és així, visiteu el Tauler de control de l’usuari i canvieu el fus horari per que coincideixi amb el de la zona on us trobeu, p.ex. Londres, París, Nova York, Sydney, etc. Tingueu en compte que, com passa amb la majoria de configuracions, només els usuaris registrats poden canviar el fus horari. Si no esteu registrat, ara és un bon moment per fer-ho.'
	),
	array(
		0 => 'He canviat el fus horari i l’hora encara està malament!',
		1 => 'Si esteu segur que heu triat correctament el fus horari i l’horari d’estiu però l’hora encara és incorrecta, llavors l’hora del servidor web és errònia. Si us plau, aviseu l’administrador per que arregli el problema.'
	),
	array(
		0 => 'El meu idioma no és a la llista!',
		1 => 'O bé l’administrador no ha instal·lat el vostre idioma o bé ningú ha traduït el phpBB al vostre idioma. Proveu de demanar-li a l’administrador del fòrum si pot instal·lar el paquet d’idioma que necessiteu. Si el paquet d’idioma no existeix, podeu crear una traducció nova. Podeu trobar més informació al lloc web del phpBB (utilitzeu l’enllaç de la part inferior de les pàgines del fòrum).'
	),
	array(
		0 => 'Com puc mostrar una imatge sota el meu nom d’usuari?',
		1 => 'Hi ha dos tipus d’imatges que poden apareixer sota el nom d’usuari quan es mostra una entrada. Depenent de l’estil utilitzat, la primera és, probablement, una imatge associada al vostre rang. Generalment tenen forma d’estrelles, blocs o punts que indiquen quantes entrades heu fet o el vostre estatus dintre del fòrum. La segona imatge, normalment més gran, és coneguda com avatar i sol ser única per cada usuari. És l’administrador qui decideix si els avatars estan permesos i tria de quines maneres estan disponibles. Si no podeu utilitzar els avatars, poseu-vos en contacte amb l’administrador i pregunteu-li la raó.'
	),
	array(
	...
	array(
		0 => 'Com publico un tema en un fòrum?',
		1 => 'Per publicar un tema en un fòrum, feu clic al botó rellevant a la pantalla del fòrum o del tema. És possible que us hagueu de registrar per poder publicar un missatge. Teniu una llista dels permisos de cada fòrum a la part inferior de les pàgines del fòrum i del tema. Per exemple: podeu publicar temes nous, votar en les enquestes, etc.'
	),
	array(
	...
	array(
		...
		1 => 'Cada administrador té les seves regles per al seu fòrum. Si heu infringit una regla, és possible que rebeu un advertiment. Tingueu en compte que això és decisió de l’administrador del fòrum i que el phpBB Group no té res a veure amb els advertiments d’aquest lloc web. Poseu-vos en contacte amb l’administrador del fòrum si no esteu segur de la raó per la qual heu rebut l’advertiment.'
	),
	array(
	...
	array(
		...
		1 => 'Aquest botó us permet desar fragments de text per completar-los i trametre’ls més tard. Per recarregar un fragment desat visiteu el Tauler de control de l’usuari.'
	),
	array(
	...
	array(
		...
		1 => 'Podeu evitar que un usuari us envïi missatges privats utilitzant les regles de missatges del Tauler de control de l’usuari. Si rebeu missatges privats insultants per part d’un usuari en particular, informeu l’administrador del fòrum ja que pot inhabilitar l’enviament de missatges per a l’usuari.'
	),
	array(
	...
	array(
		...
		1 => 'És probable que la cerca fos massa vaga i inclogués moltes paraules comunes que el phpBB3 no indexa. Sigueu més específic i utilitzeu les opcions disponibles a la cerca avançada.'
	),
	array(
	...
	array(
		...
		1 => 'Podeu recuperar les vostres entrades o bé fent clic a l’enllaç “Mostra les meves entrades” del Tauler de control de l’usuari o bé l’enllaç “Cerca les entrades d’aquest usuari” del vostre perfil. Per cercar els vostres temes, utilitzeu la pàgina de cerca avançada introduïnt les opcions apropiades.'
	),
	array(
		0 => '--',
		1 => 'Subscripcions a temes i adreces d’interès'
	),
	array(
		0 => 'Quina és la diferència entre les adreces d’interès i les subscripcions?',
		1 => 'Les adreces d’interès del phpBB3 són similars a les adreces d’interès del vostre navegador web. No rebeu un avís quan hi ha una resposta però podeu tornar al tema més tard. D’altra banda, les subscripcions us avisaran a través del vostre mètode preferit quan hi hagi una resposta en el tema o el fòrum.'
	),
	array(
		0 => 'Com puc subscriure’m a un fòrum o un tema determinats?',
		1 => 'Per subscriure-us a un fòrum determinat, feu clic a l’enllaç “Subscriu-me a aquest fòrum” quan hi entreu. Per subscriure-us a un tema, publiqueu-hi una resposta marcant la casella “Avisa’m quan s’envïi una resposta” o feu clic a l’enllaç “Subscriu-me a aquest tema” dintre del propi tema.'
	),
	array(
	...
	array(
		...
		1 => 'L’administrador de cada fòrum pot permetre o no determinats tipus de fitxers adjunts. Si no esteu segur de què es permet pujar, poseu-vos en contacte amb l’administrador del fòrum.'
	),
	array(
		0 => 'Com puc trobar tots els meus fitxers adjunts?',
		1 => 'Per trobar la llista de tots els fitxers adjunts que heu pujat, aneu al Tauler de control de l’usuari i seguiu els enllaços fins a la secció de fitxers adjunts.'
	),
	array(
		0 => '--',
		1 => 'Problemes amb el phpBB 3'
	),
	array(
		0 => 'Qui ha escrit el programari d’aquest fòrum?',
		1 => 'Aquest programari (en la seva forma no modificada) és produït, llançat i és copyright <a href="http://www.phpbb.com/">phpBB Group</a>. Es proporciona sota la GNU Llicència pública general i pot ser distribuït lliurement. Seguiu l’enllaç per obtenir més informació.'
	),
	array(
		0 => 'Per què no hi ha disponible la funció X?',
		1 => 'Aquest programari ha estat escrit i llicenciat a través del phpBB Group. Si creieu que cal afegir una determinada funció, visiteu el lloc web phpbb.com i veieu que és el que el phpBB Group hi té a dir. Si us plau, no publiqueu peticions de noves funcions al fòrum de phpbb.com, el grup utilitza SourceForge per gestionar la prioritat de les funcions noves. Si us plau, llegiu els fòrums per veure si ja hem pres una posició en referència a una determinada funció i seguiu el procediment que hi recomanem.'
	),
	array(
		0 => 'Amb qui m’he de posar en contacte per tractar temes legals o d’abús relacionats amb aquest fòrum?',
		1 => 'Qualsevols dels administradors de la llista que a pareix a la pàgina “L’equip” serà un contacte apropiat per a les vostres queixes. Si tot i així no rebeu cap resposta, és recomanable que us poseu en contacte amb el propietari del domini (feu una <a href="http://www.google.com/search?q=whois">cerca whois</a>) o, si el fòrum s’executa sobre un servei gratuït (p.ex. Yahoo!, free.fr, f2s.com, etc.), la direcció o el departament d’abús del servei en questió. Tingueu en compte que el phpBB Group <strong>no té absolutament cap jurisdicció</strong> i no pot ser fet responsable de com, on i qui utilitza aquest fòrum. No us poseu en contacte amb el phpBB Group en relació a qualsevol tema legal (cessar i desistir, responsabilització, comentaris difamatoris, etc.) <strong>no relacionat directament</strong> amb el lloc web phpBB.com o el programari phpBB en sí mateix. Si envieu un correu electrònic al phpBB Group <strong>sobre l’ús per part de tercers</strong> d’aquest programari espereu-vos una resposta succinta o, fins i tot, cap resposta.'
	)
);
