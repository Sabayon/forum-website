...
$lang = array_merge($lang, array(
	...
	'WARNINGS_EXPIRE_EXPLAIN'		=> 'Nombre de dies que han de passar abans que un advertiment venci automàticament del registre d’un usuari.',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> 'Aquesta opció indica si la resposta ràpida està habilitada o no. Si l’habiliteu, també cal que activeu la resposta ràpida dels fòrums individuals.',
...
$lang = array_merge($lang, array(
	...
	'MIN_CHAR_LIMIT_EXPLAIN'		=> 'El nombre mínim de caràcters que cal que un usuari introdueixi al text d’una entrada o missatge privat.',
	'POSTING'						=> 'Publicació',
...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	...
	'REG_LIMIT_EXPLAIN'			=> 'Nombre d’intents que pot fer un usuari al codi de confirmació abans que se li bloquegi la sessió.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_ENABLE_EXPLAIN'			=> 'Habilita o inhabilita els canlas d’informació ATOM a tots els fòrums.<br />Inhabilitar aquesta opció desactiva tots els canals independentment dels valors que hi hagi a les opcions a sota.',
	'ACP_FEED_LIMIT'					=> 'Nombre d’elements',
	'ACP_FEED_LIMIT_EXPLAIN'			=> 'El nombre màxim de canals que es mostren.',

	'ACP_FEED_OVERALL_FORUMS'			=> 'Habilita el canal general de fòrums',
	'ACP_FEED_OVERALL_FORUMS_EXPLAIN'	=> 'Aquest canal mostra les entrades més recents de tots els temes dels fòrums.',
	'ACP_FEED_OVERALL_FORUMS_LIMIT'		=> 'Nombre d’elements per pàgina que es mostren al canal de fòrums',

	'ACP_FEED_OVERALL_TOPIC'			=> 'Habilita el canal general de temes',
	'ACP_FEED_OVERALL_TOPIC_EXPLAIN'	=> 'Habilta el canal d’informació “Tots els temes”',
	'ACP_FEED_OVERALL_TOPIC_LIMIT'		=> 'Nombre d’elements per pàgina que es mostren al canal de temes',
	'ACP_FEED_FORUM'					=> 'Habilita els canals per a fòrums individuals',
	'ACP_FEED_FORUM_EXPLAIN'			=> 'Entrades noves d’un sol fòrum.',
	...
	'ACP_FEED_GENERAL'					=> 'Configuració general dels canals d’informació',

	'ACP_FEED_ITEM_STATISTICS'			=> 'Estadístiques dels elements',
	'ACP_FEED_ITEM_STATISTICS_EXPLAIN'	=> 'Mostra estadístiques individuals a sota dels elements del canal<br />(autor, data i hora, respostes, visualitzacions)',
...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'				=> 'Aquí podeu seleccionar i configurar els connectors de CAPTCHA que implementen diverses maneres de rebutjar els intents de registrar-se dels anomenats spambots (robots de brossa).',
	'AVAILABLE_CAPTCHAS'					=> 'Connectors disponibles',
	'CAPTCHA_UNAVAILABLE'					=> 'No podeu seleccionar aquest CAPTCHA ja que no es compleixen els seus requeriments.',
	...
	'CAPTCHA_GD_WAVE'						=> 'CAPTCHA GD amb distorsió d’ona',
	'CAPTCHA_GD_WAVE_EXPLAIN'				=> 'Aplica una distorsió de tipus oneig al CAPTCHA.',
	'CAPTCHA_GD_3D_NOISE'					=> 'Afegeix objectes amb soroll 3D',
	'CAPTCHA_GD_3D_NOISE_EXPLAIN'			=> 'Afegeix objectes addicionals al CAPTCHA, per sobre de les lletres.',
	'CAPTCHA_GD_FONTS'						=> 'Utilitza fonts diferents',
	'CAPTCHA_GD_FONTS_EXPLAIN'				=> 'Aquesta configuració controla quantes formes diferents de lletres s’utilitzen. Podeu utilitzar les formes per defecte o introduir lletres modificades. També és possible afegir lletres minúscules.',
	...
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'Aquest és l’aspecte que tindrà el CAPTCHA si utilitzeu la configuració actual.',

	'CAPTCHA_SELECT'						=> 'Connectors CAPTCHA instal·lats',
	'CAPTCHA_SELECT_EXPLAIN'				=> 'El menú desplegable mostra els connectors CAPTCHA reconeguts pel fòrum. Les entrades en gris no estan disponobles ara mateix i és possible que s’hagin de configurar abans de poder utilitzar-les.',
	'CAPTCHA_CONFIGURE'						=> 'Configura els CAPTCHA',
	'CAPTCHA_CONFIGURE_EXPLAIN'				=> 'Canvia la configuració del CAPTCHA seleccionat.',
	'CONFIGURE'								=> 'Configura',
	'CAPTCHA_NO_OPTIONS'					=> 'Aquest CAPTCHA no té opcions de configuració.',
	...
	'VISUAL_CONFIRM_REFRESH'				=> 'Habilita el refresc de la imatge de confirmació',
	'VISUAL_CONFIRM_REFRESH_EXPLAIN'		=> 'Permet als usuaris demanar codis de confirmació nous si no poden resoldre la confirmació visual durant el registre. És possible que alguns connectors no permetin aquesta opció.',
));
