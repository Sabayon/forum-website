...
$lang = array_merge($lang, array(
	...
	'BOOL_TYPE_EXPLAIN'		=> 'Definiu el tipus, o bé una casella de selecció o bé botons d’opció. Amb la casella de selecció, només es mostrarà per a un usuari si està activada. En aquest cas,  s’utilitzarà la <strong>segona</strong> opció d’idioma. Els botons d’opció es mostraran sense importar el seu valor.',
	...
	'DELETE_PROFILE_FIELD_CONFIRM'	=> 'Esteu segur de que voleu eliminar aquest camp del perfil?',
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> 'Amaga el camp del perfil per a tots els usuaris excepte per al propi usuari, els administradors i els moderadors, que també el poden veure. Si l’opció Mostra’l al Tauler de control de l’usuari està inhabilitada, l’usuari no podrà veure o canviar el camp i aquest només el podran canviar els administradors.',
	...
	'STEP_3_EXPLAIN_CREATE'			=> 'Com que teniu més d’un dioma instal·lat al fòrum, també heu d’omplir els elements d’idioma restants. El camp del perfil funcionarà amb l’idioma per defecte, també podeu omplir els elements d’idioma restants més tard.',
	'STEP_3_EXPLAIN_EDIT'			=> 'Com que teniu més d’un dioma instal·lat al fòrum, podeu canviar o afegir els elements d’idioma restants. El camp del perfil funcionarà amb l’idioma per defecte.',
