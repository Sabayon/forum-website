...
* 
* @package language 
* @version $Id: styles.php, v 1.0 Outubro/2009
...
$lang = array_merge($lang, array(
	'ACP_IMAGESETS_EXPLAIN'			=> 'Conjuntos de Imagens são todos os botões, Fórum, folders, etc. e outras imagens não especificamente usadas pelo Estilo do Fórum. Aqui pode editar, exportar ou apagar um Conjunto de Imagens existente e importar ou activar novos Conjuntos.',
	...
	'AUTOMATIC_EXPLAIN'				=> 'Deixe em branco para detecção automatica.',
	...
	'DELETE_IMAGESET_EXPLAIN'		=> 'Aqui pode remover o Conjunto de imagens seleccionado da Base de Dados. Adicionalmente, se tiver permissão pode seleccionar para remover o conjunto do Sistema de Ficheiros. Por favor, note que não é possível anular esta acção. Quando o conjunto de imagens é apagado não é possível recuperá-los. Deve exportar primeiro o Conjunto de Imagens para possível uso futuro.',
	'DELETE_STYLE'					=> 'Apagar Estilo',
	'DELETE_STYLE_EXPLAIN'			=> 'Aqui pode remover o Estilo seleccionado. Não pode remover todos os elementos de Estilo daqui. Eles devem ser apagados individualmente por seus respectivos formulários. Por favor, note que não é possível anular esta acção.',
	'DELETE_TEMPLATE'				=> 'Apagar Template',
	'DELETE_TEMPLATE_EXPLAIN'		=> 'Aqui pode remover o Template seleccionado da Base de Dados. Adicionalmente, se tiver permissão pode seleccionar para remover o conjunto do Sistema de Ficheiros. Por favor, note que não é possível anular esta acção. Quando os Templates são apagados não é possível recuperá-los. Deve exportar primeiro o Template para possível uso futuro.',
	'DELETE_THEME'					=> 'Apagar Tema',
	'DELETE_THEME_EXPLAIN'			=> 'Aqui pode remover o Tema seleccionado da Base de Dados. Adicionalmente, se tiver permissão, pode seleccionar para remover o Conjunto do Sistema de Ficheiros. Por favor, note que não é possível anular esta acção. Quando os Temas são apagados não é possível recuperá-los. Deve exportar primeiro o Tema para possível uso futuro.',
	'DETAILS'						=> 'Detalhes',
	...
	'IMG_ICON_USER_WARN'			=> 'Alertar Utilizador',
