...
$lang = array_merge($lang, array(
	...
	'CANNOT_DEACTIVATE_BOT'			=> 'Δεν μπορείτε να απενεργοποιήσετε bot λογαριασμούς. Απενεργοποιήστε την στατική διεύθυνση του bot.',
	...
	'CANNOT_FORCE_REACT_BOT'		=> 'Δεν σας επιτρέπετε να απενεργοποιήσετε bot λογαριασμούς. Απενεργοποιήστε την στατική διεύθυνση του bot.',
	...
	'CANNOT_SET_FOUNDER_BOT'		=> 'Δεν μπορείτε να μετατρέψετε τον λογαριασμό των αγνοουμένων μελών BOT σε αυτόν του ιδρυτή.',
	'CANNOT_SET_FOUNDER_IGNORED'	=> 'Δέν μπορείτε να προάγεται αγνοημένους χρήστες στο να είναι διαχειριστές.',
