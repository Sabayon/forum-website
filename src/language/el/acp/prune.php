...
$lang = array_merge($lang, array(
	'ACP_PRUNE_USERS_EXPLAIN'	=> 'Εδώ μπορείτε να διαγράψετε (ή να απενεργοποιήσετε) τα μέλη από την Δ. Συζήτησή σας. Αυτό μπορεί να γίνει με ποικίλους τρόπους από τον αριθμό δημοσιεύσεων, την τελευταία δραστηριότητα, κ.λπ.. Κάθε ένα από αυτά τα κριτήρια μπορεί να συνδυαστεί, έτσι ώστε μπορείτε να διαγράψετε μέλη με τελευταία ενέργεια πριν από το 2002-01-01 και λιγότερες από 10 δημοσιεύσεις. Εναλλακτικά μπορείτε να εισαγάγετε έναν κατάλογο μελών άμεσα στο κουτί κειμένου, τα άλλα κριτήρια θα αγνοηθούν. Να είστε προσεκτικοί με αυτή την λειτουργία! Μόλις διαγραφεί ένα μέλος δεν υπάρχει δυνατότητα επαναφοράς.',
	...
	'SELECT_USERS_EXPLAIN'		=> 'Καθορίστε τα ονόματα μελών εδώ, τα ποιο πάνω κριτήρια θα αγνοηθούν.',
