...
$lang = array_merge($lang, array(
	'ADM_LOGOUT'		=> 'Έξοδος',
	'ADM_LOGGED_OUT'	=> 'Έχετε αποσυνδεθεί από τον πίνακα διαχείρισης επιτυχώς',
	'LOG_REFERER_INVALID'	=> '<strong>Η επικύρωση του Referer απέτυχε</strong><br />»Το Referer ήταν “<em>%1$s</em>”. Το αίτημα απορρίφτηκε και η σύνοδος τερματίστηκε.',
	'ACP_NO_ITEMS'		=> 'Δεν υπάρχουν αντικείμενα ακόμη.',
	'SETTING_TOO_LOW'	=> 'Η τιμή που δώσατε για την ρύθμιση “%1$s” είναι πολύ μικρή. Η μικρότερη επιτρεπτή τιμή είναι %2$d.',
	'SETTING_TOO_BIG'	=> 'Η τιμή που δώσατε για την ρύθμιση “%1$s” είναι πολύ μεγάλη. Η μεγαλύτερη επιτρεπτή τιμή είναι %2$d.',
	'SETTING_TOO_LONG'	=> 'Η τιμή που δώσατε για την ρύθμιση “%1$s” είναι πολύ μεγάλη. Το μεγαλύτερο επιτρεπτό μήκος είναι %2$d.',
	'SETTING_TOO_SHORT'	=> 'Η τιμή που δώσατε για την ρύθμιση “%1$s” δεν είναι αρκετά μεγάλη. Το μικρότερο επιτρεπτό πλήθος είναι %2$d.',
	'ACP_ADMINISTRATORS'	=> 'Διαχειριστές',
	'ACP_ADMIN_LOGS'	=> 'Ιστορικό Διαχειριστών',
	'ACP_ADMIN_ROLES'	=> 'Ρόλοι Διαχειριστή',
	'ACP_ATTACHMENTS'	=> 'Συνημμενα',
	'ACP_ATTACHMENT_SETTINGS'	=> 'Ρυθμίσεις Συνημμένων',
	'ACP_AUTH_SETTINGS'	=> 'Εξουσιοδότηση',
	'ACP_AUTOMATION'	=> 'Αυτοματισμος',
	...
	'ACP_CAT_DATABASE'	=> 'Βαση Δεδομενων',
	'ACP_CAT_DOT_MODS'	=> '.MODs',
	'ACP_CAT_FORUMS'	=> 'Δημοσια Συζητηση',
	'ACP_CAT_GENERAL'	=> 'Γενικα',
	'ACP_CAT_MAINTENANCE'	=> 'Συντηρηση',
	'ACP_CAT_PERMISSIONS'	=> 'Προσβασεις',
	'ACP_CAT_POSTING'	=> 'Δημοσιευσεις',
	'ACP_CAT_STYLES'	=> 'Θεματα',
	'ACP_CAT_SYSTEM'	=> 'Συστημα',
	'ACP_CAT_USERGROUP'	=> 'Μελη και Ομαδες',
	'ACP_CAT_USERS'	=> 'Μελη',
	...
	'ACP_FORUM_BASED_PERMISSIONS'	=> 'Δ. Συζητηση με βαση τα δικαιωματα',
	'ACP_FORUM_LOGS'	=> 'Ιστορικο Δ. Συζητησης',
	...
	'ACP_GENERAL_TASKS'	=> 'Γενικες εργασιες',
	'ACP_GLOBAL_MODERATORS'	=> 'Γενικοί συντονιστές',
	'ACP_GLOBAL_PERMISSIONS'	=> 'Γενικοι περιορισμοι',
	'ACP_GROUPS'	=> 'Ομαδες',
	...
	'ACP_LOAD_SETTINGS'	=> 'Φόρτωση ρυθμίσεων',
	...
	'ACP_MESSAGES'	=> 'Μηνυματα',
	'ACP_MESSAGE_SETTINGS'	=> 'Ρυθμίσεις Προσωπικών Μηνυμάτων',
	'ACP_MODULE_MANAGEMENT'	=> 'Διαχειριση μοναδων',
	...
	'ACP_PERMISSION_MASKS'	=> 'Αποτελεσματικα Δικαιωματα',
	'ACP_PERMISSION_ROLES'	=> 'Ρολοι προσβασεων',
	...
	'ACP_STYLE_COMPONENTS'	=> 'Στοιχεια Θεματων',
	'ACP_STYLE_MANAGEMENT'	=> 'Διαχειριση Θεματων',
	'ACP_STYLES'	=> 'Θέματα',
	...
	'ACP_USER_PREFS'	=> 'Επιλογες',
	'ACP_USER_PROFILE'	=> 'Προφίλ',
	'ACP_USER_RANK'	=> 'Βαθμός',
	'ACP_USER_ROLES'	=> 'Ρόλοι μελών',
	'ACP_USER_SECURITY'	=> 'Ασφαλεια μελους',
	'ACP_USER_SIG'	=> 'Υπογραφή',
	'ACP_VC_SETTINGS'	=> 'Ρυθμίσεις Οπτικής Επιβεβαίωσης',
	...
	'LOGIN_ADMIN_CONFIRM'	=> 'Για να διαχειριστείτε την κοινότητα πρέπει ξανασυνδεθείτε.',
	...
	'BOARD_STARTED'	=> 'Ημ. έναρξης κοινότητας',
	'BOARD_VERSION'	=> 'Έκδοση λογισμικού',
	'DATABASE_SERVER_INFO'	=> 'Τύπος βάσης',
	...
	'PURGE_CACHE_EXPLAIN'	=> 'Διαγραφή όλων των αρχείων της λανθάνουσας μνήμης, όπως όλα τα αποθηκευμένα αρχεία των θεμάτων και ερωτήματα.',
	...
	'VALUE'	=> 'Τιμη',
	'VIEW_ADMIN_LOG'	=> 'Δείτε το ιστορικό διαχειριστή',
	'VIEW_INACTIVE_USERS'	=> 'Δείτε τα ανενεργά μέλη',
	'WELCOME_PHPBB'	=> 'Καλώς ήρθατε στην phpBB',
	'WRITABLE_CONFIG'      => 'Το αρχείο ρυθμίσεων (config.php) είναι Εγγράψιμο. Σας Συνιστούμε να αλλάξετε τα δικαιώματα του αρχείου αυτού σε 640 ή τουλάχιστον σε 644 (για παράδειγμα: <a href="http://en.wikipedia.org/wiki/Chmod" rel="external">chmod</a> 640 config.php).',
	'INACTIVE_DATE'	=> 'Ημερομηνία απενεργοποίησης',
	'INACTIVE_REASON'	=> 'Αιτια',
	...
	'LOG_ATTACH_FILEUPLOAD'	=> '<strong>Φορτώστε ορφανό αχρείο στην δημοσίευση</strong><br />» ID %1$d - %2$s',
	...
	'LOG_CLEAR_MOD'	=> '<strong>Διαγραφή ιστορικού Συντονιστώ</strong>',
	...
	'LOG_CONFIG_VISUAL'	=> '<strong>Μεταβολή ρυθμίσεων οπτικής επιβεβαίωσης</strong>',
	'LOG_APPROVE_TOPIC'	=> '<strong>Αποδοχή θέματος</strong><br />» %s',
	'LOG_BUMP_TOPIC'	=> '<strong>Νέα μηνύματα μέλους</strong><br />» %s',
	'LOG_DELETE_POST'	=> '<strong>Διαγραφή δημοσίευσης</strong><br />» %s',
	'LOG_DELETE_SHADOW_TOPIC'   => '<strong>Το θέμα συνδέσμου διαγράφηκε </strong><br />» %s',
    'LOG_DELETE_TOPIC'         => '<strong>Το θέμα διαγράφηκε</strong><br />» %s',
    'LOG_FORK'               => '<strong>Το θέμα αντιγράφηκε</strong><br />» απο %s',
    'LOG_LOCK'               => '<strong>Το θέμα κλειδώθηκε</strong><br />» %s',
    'LOG_LOCK_POST'            => '<strong>Η δημοσίευση κλειδώθηκε</strong><br />» %s',
    'LOG_MERGE'               => '<strong>Οι δημοσιεύσεις συγχωνεύθηκαν</strong> στο θέμα<br />» %s',
    'LOG_MOVE'               => '<strong>Μετακινήθηκε το θέμα</strong><br />» απο %1$s σε %2$s',
	...
	'LOG_FORUM_DEL_FORUMS'	=> '<strong>Διαγραφή Δ. Συζήτησης και των υπόφόρουμ του</strong><br />» %s',
	'LOG_FORUM_DEL_MOVE_FORUMS'	=> '<strong>Διαγραφή Δ. Συζήτησης ς και μεταφορά των υπόφόρουμ του</strong> στο %1$s<br />» %2$s',
	'LOG_FORUM_DEL_MOVE_POSTS'	=> '<strong>Διαγραφή Δ. Συζήτησης και μεταφορά των θεμάτων του </strong> στο %1$s<br />» %2$s',
    'LOG_FORUM_DEL_MOVE_POSTS_FORUMS'      => '<strong>Διαγραφή Δ. Συζήτησης και των υποφόρουμ, μετακίνηση των δημοσιεύσεων</strong> σε %1$s<br />» %2$s',
    'LOG_FORUM_DEL_MOVE_POSTS_MOVE_FORUMS'   => '<strong>Διαγραφή Δ. Συζήτησης, μετακίνηση των δημοσιεύσεων</strong> σε %1$s <strong>και υποφόρουμ</strong> σε %2$s<br />» %3$s',
    'LOG_FORUM_DEL_POSTS'               => '<strong>Διαγραφή Δ. Συζήτησης και των δημοσιεύσεων</strong><br />» %s',
    'LOG_FORUM_DEL_POSTS_FORUMS'         => '<strong>Διαγραφή Δ. Συζήτησης, των δημοσιεύσεων και των υποφόρουμ</strong><br />» %s',
    'LOG_FORUM_DEL_POSTS_MOVE_FORUMS'      => '<strong>Διαγραφή Δ. Συζήτησης και των δημοσιεύσεων, μετακίνηση των υποφόρουμ</strong> σε %1$s<br />» %2$s',
	...
	'LOG_STYLE_ADD'	=> '<strong>Προστέθηκε νέο θέμα</strong><br />» %s',
	'LOG_STYLE_DELETE'	=> '<strong>Διαγράφτηκε θέμα</strong><br />» %s',
	'LOG_STYLE_EDIT_DETAILS'	=> '<strong>Επεξεργάσθηκε θέμα</strong><br />» %s',
	'LOG_STYLE_EXPORT'	=> '<strong>Εξήχθη θέμα</strong><br />» %s',
