...
//
// Πληροφορίες Μετάφρασης
//
// Έκδοση: 			1.02
// Ημερομηνία:  	11/07/2008 21:11:22
// Κάτοχος: 		Athanasios Ziouzios Panagioths Mixas Konstantakelhs Panagioths Giannis Orfanidis
//
//
// ΜΕΤΑΦΡΑΣΗ: ΑΔΕΙΑ
//
...
// TRANSLATION: TOOLS
//
// Special characters: ’ » “ ” … É À
// Subversion repository: svn checkout http://code.phpbb.com/svn/phpbb/trunk/phpBB
//

// Board Settings
$lang = array_merge($lang, array(
	'NO_REF_VALIDATION'				=> 'Κανένα',
	'REF_HOST'						=> 'Μόνο επικύρωση του host',
	'REF_PATH'						=> 'Επίσης επικύρωση διαδρομής',
	'REFERER_VALID'					=> 'Επικύρωση Referer',
	'REFERER_VALID_EXPLAIN'			=> 'Εάν ενεργοποιηθεί, το referer των POST αιτημάτων θα ελεγχθεί σε σχέση με την διαδρομή του host/script path. Αυτό μπορεί να προκαλέσει προβλήματα σε φόρουμ που χρησιμοποιούν περισσότερο από ένα Domain names και ή εξωτερικές συνδέσεις.',
	'ACP_BOARD_SETTINGS_EXPLAIN'	=> 'Εδώ μπορείτε να καθορίσετε τις βασικές ρυθμίσεις του φορουμ σας, να δώσετε ένα όνομα, μία περιγραφή και μεταξύ όλων αυτών να αλλάξετε τις προκαθορισμένες επιλογές για την ζώνη ώρας και τη γλώσσα.',
	...
	'SYSTEM_TIMEZONE'				=> 'Μορφή ώρας συστήματος',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_MASS_PM_EXPLAIN'     => 'Η αποστολή μηνυμάτων σε ομάδες μελών μπορεί να ρυθμιστεί απο το μενού διαχείριση ομάδας του πίνακα ελέγχου.',
	...
	'PM_MAX_RECIPIENTS'         => 'Μέγιστος επιτρεπόμενος αριθμός παραληπτών',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_QUEUE_TRIGGER'        	    => 'Ενεργοποίηση ουράς δημοσιεύσεων',
    'ENABLE_QUEUE_TRIGGER_EXPLAIN'   	=> 'Δυνατότητα να θέσετε τις δημοσιεύσεις των εγγεγραμμένων μελλών σε αναμονή για έγκριση εάν ο αριθμός δημοσιεύσεών τους είναι μικρότερος από την συγκεκριμένη τιμή παρακάτω . Αυτή η ρύθμιση δεν έχει εφαρμογή στην ρύθμιση για το αν οι δημοσιεύσεις του φόρουμ χρειάζονται έγκριση ή όχι.',
    'QUEUE_TRIGGER_POSTS'         		=> 'Μέγιστος αριθμός δημοσιεύσεων ουράς',
    'QUEUE_TRIGGER_POSTS_EXPLAIN'   	=> 'Αν η ουρά δημοσιεύσεων είναι ενεργοποιημένη, αυτός είναι ο αριθμός των δημοσιεύσεων που το μέλος πρέπει έχει για να δημοσιεύει χωρίς να χρειάζεται έγκριση. Αν ο αριθμός των δημοσιεύσεων του μέλους είναι μικρότερος από αυτό τον αριθμό, η δημοσίευση αποθηκεύεται στην ουρά αυτομάτως.',

	'BUMP_INTERVAL'					=> 'Σημείωση νέων μπορεί να γίνει μετά',
	'BUMP_INTERVAL_EXPLAIN'			=> 'Αριθμός σε λεπτά, ώρες ή ημέρες μεταξύ της τελευταίας δημοσίευσης σε ένα θέμα που πρέπει να περάσει για να σημειωθεί το θέμα ως νέο.',
	'CHAR_LIMIT'					=> 'Μέγιστος αριθμός χαρακτήρων στην δημοσίευση',
	'CHAR_LIMIT_EXPLAIN'			=> 'Ο αριθμός χαρακτήρων που επιτρέπετε σε μια δημοσίευση. Θέστε αυτό 0 χωρίς όριο.',
...
//	'ACC_USER_ADMIN'			=> 'Μέλος + Διαχειριστής',
	...
	'MAX_CHARS'					=> 'Μέγιστο',
	'MIN_CHARS'					=> 'Ελάχιστο',
	'MIN_TIME_REG'				=> 'Ελάχιστος χρόνος για την εγγραφή',
	'MIN_TIME_REG_EXPLAIN'		=> 'Η αίτηση εγγραφής δεν μπορεί να υποβληθεί πριν  αυτή η σύνοδος  περάσει.',
	'MIN_TIME_TERMS'			=> 'Ελάχιστος χρόνος για την αποδοχή των όρων',
	'MIN_TIME_TERMS_EXPLAIN'	=> 'Η σελίδα όρων δεν μπορεί να προσπελαστεί πριν από αυτή η σύνοδος  περάσει.',
...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'		=> 'Εδώ είστε σε θέση να ρυθμίσετε τις οπτικές προεπιλογές επιβεβαίωσης και τις τοποθετήσεις CAPTCHA.',

	'CAPTCHA_GD'							=> 'GD CAPTCHA',
	'CAPTCHA_GD_FOREGROUND_NOISE'			=> 'GD CAPTCHA σε πρώτο πλάνο θόρυβος',
	'CAPTCHA_GD_EXPLAIN'					=> 'Χρησιμοποιείστε την GD-Βιβλιοθήκη για να δημιουργήσετε περισσότερους CAPTCHA κώδικες.',
	'CAPTCHA_GD_FOREGROUND_NOISE_EXPLAIN'	=> 'Χρησιμοποιήστε το πρώτο πλάνο θόρυβο για την δημιουργία της GD-Βιβλιοθήκης βασιζόμενη στους CAPTCHA κώδικες προκειμένου να γίνει μια αυτόματη αναγνώριση ακόμη δυσκολότερη.',
	'CAPTCHA_GD_X_GRID'						=> 'GD CAPTCHA χρώμα φόντου θόρυβος x-axis',
	'CAPTCHA_GD_X_GRID_EXPLAIN'				=> 'Χρησιμοποιήστε μια χαμηλή αξία, προκειμένου να κατασταθεί η GD-Βιβλιοθήκη βασισμένο CAPTCHA δυσκολότερο. 0 θα απενεργοποιηθεί το χρώμα φόντου θόρυβος x-axis.',
	'CAPTCHA_GD_Y_GRID'						=> 'GD CAPTCHA πρώτο πλάνο θόρυβος y-axis',
	'CAPTCHA_GD_Y_GRID_EXPLAIN'				=> 'Χρησιμοποιήστε μια χαμηλή αξία, προκειμένου να κατασταθεί η GD-Βιβλιοθήκη βασισμένο CAPTCHA δυσκολότερο. 0 θα απενεργοποιηθεί το χρώμα φόντου θόρυβος y-axis.',
    'CAPTCHA_GD_WAVE'      		            => 'GD CAPTCHA κυμματική διαστροφή',
    'CAPTCHA_GD_WAVE_EXPLAIN'               => 'Αυτό χρησιμοποιέι μία κυμματική διαστροφή στο CAPTCHA.',
    'CAPTCHA_GD_3D_NOISE'                   => 'Πρόσθήκη τρισδιάστατων αντικειμένων θορύβου',
    'CAPTCHA_GD_3D_NOISE_EXPLAIN'           => 'Αυτό προσθέτει πρόσθετα αντικείμενα στο CAPTCHA, πάνω απο τα γράμματα.',
    'CAPTCHA_GD_FONTS'                      => 'Χρησιμοποιήστε διαφορετικες γραμματοσειρές',
    'CAPTCHA_GD_FONTS_EXPLAIN'              => 'Αυτή η ρύθμιση ελέγχει πόσα διαφορετικά σχήματα χρησιμοποιούνται. Μπορείτε απλά να χρησιμοποιήσετε τα προεπιλεγμένα σχήματα ή να εισάγετε αλλαγμένα γράμματα. Η προσθήκη μικρών γραμμάτων επίσης επιτρέπεται.',
    'CAPTCHA_FONT_DEFAULT'                  => 'Προεπιλογή',
    'CAPTCHA_FONT_NEW'                      => 'Νέα σχήματα',
    'CAPTCHA_FONT_LOWER'                    => 'Χρησιμοποίηση μικρών γραμμάτων επίσης',	

	'CAPTCHA_PREVIEW_MSG'					=> 'Η δικές σας αλλαγές και η ρυθμίσεις στην οπτική επιβεβαίωση δεν αποθηκεύτηκαν. Αυτό είναι μόνο μια προεπισκόπηση.',
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'Έτσι θα εμφανίζεται ο κώδικας επιβεβαίωσης με τις τρέχων ρυθμίσεις. Πατώντας προεπισκόπιση μπορείτε να τον ενημερώσετε. Σημειώστε ότι ο κώδικας οπτικής επιβεβαίωσης θα εμφανίζεται διαφορετικά από ότι εδώ',
	'VISUAL_CONFIRM_POST'					=> 'Ενεργοποιήστε κώδικα οπτικής επιβεβαίωσης για δημοσιεύσεις επισκεπτών',
	'VISUAL_CONFIRM_POST_EXPLAIN'			=> 'Επισκέπτες θα πρέπει να προσθέσουν τον τυχαίο κώδικα οπτικής επιβεβαίωσης που θα εμφανίζεται στην εικόνα κατά την αποστολή της δημοσίευσης.',
	'VISUAL_CONFIRM_REG'					=> 'Ενεργοποιήστε κώδικα οπτικής επιβεβαίωσης στις εγγραφές',
	'VISUAL_CONFIRM_REG_EXPLAIN'			=> 'Νέα μέλη θα πρέπει να προσθέσουν τον τυχαίο κώδικα οπτικής επιβεβαίωσης που θα εμφανίζεται στην εικόνα κατά την εγγραφή τους. Αυτό θα βοηθήσει εσάς να αποφύγετε μαζικές εγγραφές.',
	'VISUAL_CONFIRM_REFRESH'                => 'Ενεργοποιέι τη δυνατότητα οι χρήστες να ανανεώνουν τον κωδικό επιβεβαίωσης',
    'VISUAL_CONFIRM_REFRESH_EXPLAIN'        => 'Επιτρέπει τους χρήστες να ζητήσουν νέο κώδικα επιβεβαίωσης, αν δεν μπορουν να λύσουν τον κωδικα επιβεβαιωσης κατα την εγγραφή.',
));
...
$lang = array_merge($lang, array(
	...
	'YES_BIRTHDAYS_EXPLAIN'         => 'Αν απενεργοποιηθεί τότε η λίστα γενεθλίων δε θα εμφανίζεται. Για να έχει εφαρμογή αυτή η ρύθμιση το χαρακτηριστικό των γενεθλίων θα πρέπει να είναι επίσης ενεργοποιημένο.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_GZIP_EXPLAIN'		=> 'Το περιεχόμενο συμπιέζεται πριν σταλεί στο χρήστη. Αυτό μπορεί οδηγήσει στην μείωση του δικτύου, επιπλέον, σε μια αύξηση φορτίου του επεξεργαστή και στον κεντρικό υπολογιστή όπως επίσης και στην σελίδα των χρηστών.',
...
$lang = array_merge($lang, array(
	...
	'FORM_TIME_MIN'					=> 'Ελάχιστος χρόνος για να υποβληθούν οι μορφές',
	'FORM_TIME_MIN_EXPLAIN'			=> 'Υποβολές γρηγορότερα από αυτόν τον χρόνο αγνοούνται από τον πίνακα. Χρησιμοποιείστε  0 για απενεργοποίηση.',
	'FORM_SID_GUESTS'				=> 'Αυτό διαμορφώνει τις συνόδους επισκεπτών',
	'FORM_SID_GUESTS_EXPLAIN'		=> 'Εάν αυτό είναι ενεργοποιημένο, το σημείο μορφής που διανέμεται στους στους θα είναι σύνοδος-αποκλειστικό. Αυτό μπορεί να προκαλέσει προβλήματα με διάφορα  ISPs.',
...
$lang = array_merge($lang, array(
	...
	'EMAIL_PACKAGE_SIZE_EXPLAIN'    => 'Αυτός είναι ο μέγιστος αριθμός των email που αποστέλλονται σε ένα πακέτο. Αυτή η ρύθμιση εφαρμόζεται στην εσωτερική ουρά μηνυμάτων;βαλτε αυτή την τιμή σε 0 αν έχετε προβλήματα με ειδοποιήσεις μη-παραδοτέων email.',
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'Εάν αυτό είναι απενεργοποιημένο, κανένα ηλεκτρονικό ταχυδρομείο δεν θα αποστέλλεται από την Δ. Συζήτησης.',
	...
	'SMTP_PASSWORD_EXPLAIN'			=> 'Προσθέστε μόνο τον κωδικό εάν ο SMTP κεντρικός υπολογιστής απαιτεί αυτό.',
	'SMTP_PLAIN'					=> 'Απλό',
...
$lang = array_merge($lang, array(
	...
	'JAB_USERNAME'              => 'Ονομα χρήστη Jabber ή JID',
    'JAB_USERNAME_EXPLAIN'      => 'Εισάγεται ένα εγγεγραμμένο όνομα χρήστη λογαριασμού Jabber. Το όνομα χρήστη δεν θα ελεγχθεί για την εγκυρότητά του.  Αν εισάγετε μόνο ένα όνομα χρήστη τότε το JID θα είναι το όνομα χρήστη και ο σερβερ που επιλέξατε παραπάνω. Αλλιώς, εισάγετε ένα έγκυρο JID, παράδειγμα user@jabber.org.',
));
