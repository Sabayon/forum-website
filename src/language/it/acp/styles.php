...
$lang = array_merge($lang, array(
	...
	'DELETE_IMAGESET_EXPLAIN'	=> 'Qui puoi eliminare un determinato set-immagini dal database. Se hai i permessi necessari, è anche possibile cancellare il set-immagini dal file di configurazione. Attenzione: non esiste la possibilità di tornare indietro! La cancellazione di un set-immagini è definitiva. Si raccomanda di eseguire un export prima di cancellarlo, per poter usare in futuro queste immagini.',
	...
	'DELETE_TEMPLATE_EXPLAIN'	=> 'Qui puoi cancellare dal database un template. Se hai i permessi necessari, è anche possibile cancellare il set dal file di configurazione. Attenzione: non esiste la possibilità di tornare indietro! La cancellazione dei template è definitiva. Si raccomanda di eseguire un export prima di cancellarlo, per possibile uso futuro di questo template.',
