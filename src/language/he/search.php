...
$lang = array_merge($lang, array(
	...
	'SEARCH_KEYWORDS_EXPLAIN'	=> 'הצב <strong>+</strong> לפני מילה שחייבת להמצא ולהכלל בתוצאות החיפוש שלך, או <strong>-</strong> לפני מילה שלא חייבת. תוכל גם לרשום רשימת מילים מופרדות ב <strong>|</strong> וכל התאמה מאחת המילים תוצג לך בתוצאות החיפוש. השתמש ב * (כוכבית) כתו משלים.',	
