...
$lang = array_merge($lang, array(
	...
	'DELETE_IMAGESET_EXPLAIN'	=> 'כאן אתה יכול למחוק ערכות תמונה ממסד הנתונים.בנוסף, אם יש לך את ההרשאות הנדרשות, אתה יכול למחוק ערכות תמונה גם מקבצי המערכת.שים לב, לא ניתן לשחזר ערכות תמונה שנמחקו.מומלץ לייצא קודם את ערכת התמונה שאתה מעוניין למחוק אל מנת לאפשר שימוש עתידי במקרה הצורך.',
	'DELETE_STYLE'				=> 'מחק עיצוב',
	'DELETE_STYLE_EXPLAIN'		=> 'כאן אתה יכול למחוק עיצובים.אינך יכול למחוק אלמנטי עיצוב באפליקציה זו (ערכות תמונה, סגנונות עיצוב), ישנן אפליקציות אחרות התומכות באפשרויות אלו.שים לב שלא ניתן לשחזר עיצובים שנמחקו.',
	'DELETE_TEMPLATE'			=> 'מחק תבנית עיצוב',
	'DELETE_TEMPLATE_EXPLAIN'	=> 'כאן אתה יכול למחוק תבניות עיצוב ממסד הנתונים.בנוסף, אם יש לך את ההרשאות הנדרשות אתה יכול למחוק אותן גם מקבצי המערכת.אנא שים לב שלא ניתן לשחזר תבניות עיצוב שנמחקו.מומלץ לייצא את תבניות העיצוב קודם, על מנת לאפשר שימוש עתידי בהתאם לצורך.',
	'DELETE_THEME'				=> 'מחק סגנון עיצוב',
	'DELETE_THEME_EXPLAIN'		=> 'כאן אתה יכול למחוק סגנונות עיצוב ממסד הנתונים.בנוסף, אם יש לך את ההרשאות הנדרשות אתה יכול גם למחוק אותם מקבצי המערכת.שים לב שלא ניתן לשחזר סגנונות שנמחקו.מומלץ קודם לייצא את הסגנונות על מנת לאפשר שימוש עתידי בהתאם לצורך.',
	'DETAILS'					=> 'פרטים',
	...
	'EDIT_DETAILS_TEMPLATE_EXPLAIN'		=> 'כאן אתה יכול לערוך פרטים מסויימים של תבניות עיצוב כמו השם.בנוסף יש לך גם האפשרות להעביר את אחסון גיליון העיצוב מקבצי המערכת למסד הנתונים.האפשרות הזו תלויה בהגדרות ה-PHP בשרת שלך.',
	'EDIT_DETAILS_THEME'				=> 'ערוך פרטי סגנון עיצוב',
	'EDIT_DETAILS_THEME_EXPLAIN'		=> 'כאן אתה יכול לערוך פרטים מסויימים של סגנונות עיצוב כמו השם.בנוסף יש לך גם האפשרות להעביר את אחסון גיליון העיצוב מקבצי המערכת למסד הנתונים.האפשרות הזו תלויה בהגדרות ה-PHP בשרת שלך.',
	'EDIT_IMAGESET'						=> 'ערוך ערכת תמונה',
	'EDIT_IMAGESET_EXPLAIN'				=> 'כאן אתה יכול לערוך תמונות אשר מרכיבות את ערכת התמונה.אתה יכול גם לבחור מימדים עבור התמונה.מימדים הם בגדר בחירה, ובחירה בהם עלולה לשנות מאפייני תצוגה בדפדפנים מסויימים.אי בחירה בהם יכולה להיות חיסכון מקום במסד הנתונים.',
	'EDIT_TEMPLATE'						=> 'ערוך תבנית עיצוב',
	'EDIT_TEMPLATE_EXPLAIN'				=> 'כאן אתה יכול לעורך תבניות עיצוב באופן ישיר.אנא זכור כי שינויים אלו קבועים ואינם יכולים להיות בלתי גמורים בעת שליחה.אם הגדרות ה-PHP שלך מאפשרות ל-PHP לכתוב בקבצי העיצוב שבתיקיית העיצוב שלך, כל השינויים שיעשו פה יתבצעו גם בקבצים האלו.אם PHP לא מאופשרת לעשות זאת כל השינויים יועתקו אל מסד הנתונים בלבד.אנא דאג, בעת העריכה לסגור את כל המשתנים כהלכה {XXXX} וכמו כן גם משפטי תנאי.',
	'EDIT_TEMPLATE_STORED_DB'			=> 'קובץ העיצוב אינו ניתן היה לכתיבה לכן נתוני העיצוב מאוחסנים כעת במסד הנתונים.',
	'EDIT_THEME'						=> 'ערוך סגנון עיצוב',
	'EDIT_THEME_EXPLAIN'				=> 'כאן באפשרותך לערוך סגנונות נבחרים, לשנות צבעים, תמונות וכדומה.',
	'EDIT_THEME_STORED_DB'				=> 'קובץ גיליון העיצוב לא ניתן היה לכתיבה לכן הוא מאוכסן כעת במסד הנתונים בהתאם להגדרותיך.',
	...
	'IMAGESET_ADDED_DB'			=> 'ערכת תמונה חדשה נוספה למסד הנתונים.',
	'IMAGESET_DELETED'			=> 'ערכת התמונה נמחקה בהצלחה.',
	'IMAGESET_DELETED_FS'		=> 'ערכת התמונה נמחקה בהצלחה ממסד הנתונים, אך קבצים מסויימים עלולים להישאר בין קבצי המערכת',
	...
	'IMG_FORUM_UNREAD'			=> 'הודעות חדשות בפורום',
	'IMG_FORUM_UNREAD_LOCKED'	=> 'הודעות נעולות חדשות בפורום',
	'IMG_FORUM_UNREAD_SUBFORUM'	=> 'הודעות חדשות בתת פורום',
	'IMG_SUBFORUM_READ'			=> 'מקרא תת פורום',
	'IMG_SUBFORUM_UNREAD'		=> 'מקרא הודעות חדשות בתת פורום',
	...
	'IMG_STICKY_UNREAD'				=> 'נושאים דביקים נעולים חדשים',
	'IMG_STICKY_UNREAD_MINE'		=> 'נושא דביק נשלח ל',
	'IMG_STICKY_UNREAD_LOCKED'		=> 'נושאים דביקים נעולים חדשים',
	...
	'IMG_ANNOUNCE_UNREAD'				=> 'הכרזות חדשות',
	'IMG_ANNOUNCE_UNREAD_MINE'			=> 'הכרזה נשלחה ל',
	'IMG_ANNOUNCE_UNREAD_LOCKED'		=> 'הכרזות נעולות חדשות',
	...
	'IMG_GLOBAL_UNREAD'					=> 'הכרזות גלובאליות חדשות',
	'IMG_GLOBAL_UNREAD_MINE'			=> 'הכרזה גלובאלית נשלחה ל',
	'IMG_GLOBAL_UNREAD_LOCKED'			=> 'הכרזות גלובאליות נעולות חדשות',
	...
	'TEMPLATE_ADDED_DB'			=> 'ערכת תבנית העיצוב נוספה בהצלחה למסד הנתונים.',
	...
	'TEMPLATE_DELETED_FS'		=> 'תבנית העיצוב נמחקה בהצלחה ממסד הנתונים אך קבצים מסויימים נשארו בקבצי המערכת.',
	...
	'THEME_ADDED'				=> 'סגנון חדש נוסף למסד הנתונים.',
	'THEME_ADDED_DB'			=> 'סגנון עיצוב חדש נוסף למסד הנתונים.',
	'THEME_CLASS_ADDED'			=> 'המחלקה נוספה בהצלחה.',
	'THEME_DELETED'				=> 'הסגנון נמחק בהצלחה.',
	'THEME_DELETED_FS'			=> 'הסגנון נמחק ממסד הנתונים אך קבצים מסויימים נשארו בקבצי המערכת.',
