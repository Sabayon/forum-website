...
// User Permissions
$lang = array_merge($lang, array(
	'acl_u_viewprofile'	=> array('lang' => 'רשאי לצפות בפרופילים, רשימת משתמשים, ורשימת מחוברים', 'cat' => 'profile'),
	...
	'acl_u_chggrp'		=> array('lang' => 'רשאי לשנות את קבוצת המשתמשים', 'cat' => 'profile'),
	...
	'acl_u_sendpm'		=> array('lang' => 'רשאי לשלוח הודעה פרטית', 'cat' => 'pm'),
	...
	'acl_u_viewonline'	=> array('lang' => 'רשאי לראות משתמשים מוסתרים מחוסקים', 'cat' => 'misc'),
...
'acl_m_info'	=> array('lang' => 'רשאי לראות פרטי הודעה', 'cat' => 'misc'),
	'acl_m_warn'	=> array('lang' => 'רשאי לפרסם אזהרות<br /><em>הגדרה זו נקבעת באופן גלובאלי בלבד. היא אינה שייכת לפורום מסוים.</em>', 'cat' => 'misc'), // This moderator setting is only global (and not local)
...
$lang = array_merge($lang, array(
	...
	'acl_a_backup'		=> array('lang' => 'רשאי לגבות/לשחזר מסד נתונים', 'cat' => 'misc'),
