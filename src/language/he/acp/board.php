...
$lang = array_merge($lang, array(
	...
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> 'אפשרות זו מגדירה אם תגובה מהירה פעילה או לא. אם אפשרות זו פעילה, יש לאפשר גם בפורומים את אפשרות זו.',
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> 'אם תגדיר לכן והגבלת ההודעות למשתמש חדש מוגדרת משתמשים שנרשמו לאחרונה לא רק יוכנסו לקבוצת ה<em>משתמשים שנרשמו לאחרונה</em>, הקבוצה תהפוך לקבוצת ברירת המחדל שלהם. אפשרות זו יכולה להיות יעילה אם אתה רוצה להגדיר לקבוצה דירוג ו/או סמל אישי שהמשתמש יקבל.',
...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	...
	'REG_LIMIT_EXPLAIN'			=> 'מספר הנסיונות שמשתמשים יכולים לנסות להזין את קוד האישור לפני שהם ינעלו בחוץ בחיבור זה.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_OVERALL_FORUMS'			=> 'אפשר הזנות לכלל הפורומים',
	'ACP_FEED_OVERALL_FORUMS_EXPLAIN'   => 'הזנה זו תציג את ההודעות האחרונות מכל הנושאים בפורומים.',
	'ACP_FEED_OVERALL_FORUMS_LIMIT'		=> 'מספר הפריטים להצגה בכל עמוד בהזנת הפורומים',

	'ACP_FEED_OVERALL_TOPIC'			=> 'אפשר הזנה כוללת בנושאים',
	'ACP_FEED_OVERALL_TOPIC_EXPLAIN'	=> 'מאפשר את ההזנה “בכל הנושאים”',
	'ACP_FEED_OVERALL_TOPIC_LIMIT'		=> 'מספר הפריטים להצגה בכל עמוד בהזנת הנושאים',
	'ACP_FEED_FORUM'					=> 'אפשר הזנות לפי פורום',
	'ACP_FEED_FORUM_EXPLAIN'			=> 'הודעות חדשות בפורום מסויים.',
	...
	'ACP_FEED_ITEM_STATISTICS_EXPLAIN'	=> 'הצג סטטיסטיקה מתחת לפרטי ההזנות<br />(נשלח על ידי, תאריך וזמן, תגובות, צפיות)',
	'ACP_FEED_EXCLUDE_ID'				=> 'הסתר פורומים אלו',
	'ACP_FEED_EXCLUDE_ID_EXPLAIN'		=> 'תוכן מפורומים אלו <strong>לא יצורף להזנות</strong>.אל תבחר באף פורום כדי למשוך מידע מכל הפורומים.<br />בחר/בטל בחירה של כמה פורומים על ידי לחיצה על <samp>CTRL</samp> ולחיצה בעכבר.',
));

// Visual Confirmation Settings
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'				=> 'כאן אתה יכול לבחור ולהגדיר תוספות לCAPTCHA, שמשמשות למגוון דרכים למנוע רישום של רובוטים.',
	'AVAILABLE_CAPTCHAS'					=> 'תוספות זמינות',
	'CAPTCHA_UNAVAILABLE'					=> 'הCAPTCHA לא ניתן לבחירה מכיוון שהדרישות שלה לא נענו.',
	'CAPTCHA_GD'							=> 'ספריה גראפית של CAPTCHA',
	'CAPTCHA_GD_3D'							=> 'ספריה גראפית תלת מימדית של Captcha',
	'CAPTCHA_GD_FOREGROUND_NOISE'			=> 'רעש רקע של הספריה הגראפית של CAPTCHA',
	'CAPTCHA_GD_EXPLAIN'					=> 'השתמש בספריה גראפית כדי לגרום ל CAPTCHA להיות מתקדם יותר.',
	'CAPTCHA_GD_FOREGROUND_NOISE_EXPLAIN'	=> 'השתמש ברעש רקע כדי לגרום לספריה גראפית המבוסס על CAPTCHA להיות חזק יותר.',
	'CAPTCHA_GD_X_GRID'						=> 'רעש רקע של ספריה גראפית CAPTCHA בציר x',
	'CAPTCHA_GD_X_GRID_EXPLAIN'				=> 'השתמש בהגדרות נמוכות יותר כדי לגרום לספריה גראפית המבוסס על CAPTCHA להיות חזק יותר. 0 יכבה את רעש הרקע של ציר ה x.',
	'CAPTCHA_GD_Y_GRID'						=> 'רעש רקע של ספריה גראפית CAPTCHA בציר y',
	'CAPTCHA_GD_Y_GRID_EXPLAIN'				=> 'השתמש בהגדרות נמוכות יותר כדי לגרום לספריה גראפית המבוסס על CAPTCHA להיות חזק יותר. 0 יכבה את רעש הרקע של ציר ה y.',
	'CAPTCHA_GD_WAVE'                  => 'גל עיוות לספריה גראפית של CAPTCHA',
	'CAPTCHA_GD_WAVE_EXPLAIN'            => 'אפשרות זו מוסיפה גל עיוות ל CAPTCHA.',
	'CAPTCHA_GD_3D_NOISE'               => 'הוסף אובייקטי רעש תלת מימדיים',
	'CAPTCHA_GD_3D_NOISE_EXPLAIN'         => 'אפשרות זו מוסיפה אובייקטים ל CAPTCHA, מעל האותיות.',
	'CAPTCHA_GD_FONTS'                  => 'השתמש בגופנים שונים',
	'CAPTCHA_GD_FONTS_EXPLAIN'            => 'הגדרה זו מאפשרת לשנות את מספר צורות האות השונות אשר בשימוש. תוכל להשתמש בצורות ברירת המחדל בלבד או להציג אותיות שונות. הוספת אותיות לועזיות קטנות אפשרית גם כן.',
	'CAPTCHA_FONT_DEFAULT'               => 'ברירת מחדל',
	'CAPTCHA_FONT_NEW'                  => 'צורות חדשות',
	'CAPTCHA_FONT_LOWER'               => 'השתמש גם באותיות קטנות',

	'CAPTCHA_NO_GD'							=> 'CAPTCHA ללא ספריה גראפית',
	'CAPTCHA_PREVIEW_MSG'					=> 'השינויים שלך לאימות החזותי לא נשמרו. זו היא רק תצוגה מקדימה.',
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'הCAPTCHA כפי שתראה בשימוש בבחירות הנוכחיות.',

	'CAPTCHA_SELECT'						=> 'התקן תוספות לCAPTCHA',
	'CAPTCHA_SELECT_EXPLAIN'				=> 'התפריט הנפתח מכיל את התוספות CAPTCHA המזוהים על ידי המערכת. ערכים אפורים לא זמינים כרגע ויתכן ויזדקקו להגדרות לפני השימוש.',
	'CAPTCHA_CONFIGURE'						=> 'הגדרות CAPTCHA',
	'CAPTCHA_CONFIGURE_EXPLAIN'				=> 'שנה את ההגדרות שאלת האימות שנבחרה.',
	'CONFIGURE'								=> 'הגדר',
	'CAPTCHA_NO_OPTIONS'					=> 'לCAPTCHA זה אין אפשרויות מוגדרות.',

	'VISUAL_CONFIRM_POST'					=> 'אפשר אימות חזותי לשליחת הודעות של אורחים',
	'VISUAL_CONFIRM_POST_EXPLAIN'			=> 'דורש מאורחים להכניס קוד רנדומלי שתואם לתמונה בשביל למנוע הצפה של שליחת הודעות.',
	'VISUAL_CONFIRM_REG'					=> 'אפשר אימות חזותי לנרשמים',
	'VISUAL_CONFIRM_REG_EXPLAIN'			=> 'דורש ממשתמשים חדשים להכניס קוד רנדומלי שתואם לתמונה בשביל למנוע הצפה של הרשמה.',
	'VISUAL_CONFIRM_REFRESH'				=> 'אפשר למשתמשים לרענן את קוד האימות בתמונה',
	'VISUAL_CONFIRM_REFRESH_EXPLAIN'		=> 'מאפשר למשתמשים לצור קוד אימות חדש, אם הם לא יכולים לפתור את האימות החזותי בזמן ההרשמה. יכול להיות שישנם תוספות שלא יאפשרו את אפשרות זו.',
));
...
$lang = array_merge($lang, array(
	...
	'MAX_LOGIN_ATTEMPTS_EXPLAIN'	=> 'לאחר מספר זה של נסיונות שנכשלו המשתמש צריך בנוסף לאשר את ההתחברות שלו בעזרת אימות חזותי.',
