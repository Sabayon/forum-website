...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		'TEXT'			=> 'Orice text, inclusiv caractere străine, numere, etc… Ar trebui să nu folosiţi acest simbol în etichetele HTML. Mai degrabă încercaţi să folosiţi IDENTIFICATOR sau TEXTSIMPLU ',
		...
		'LOCAL_URL'		=> 'O adresă web locală. Adresa web trebuie să fie relativă la pagina subiectului şi nu poate conţine un nume de server sau protocol',
...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Aici puteţi controla numele de utilizatori ce nu pot fi folosite.  Numele dezactivate ale utilizatorilor pot conţine un wildcard pentru *. Reţineţi că nu puteţi dezactiva un nume de utilizator ce este deja înregistrat, mai întâi trebuie să îl ştergeţi, apoi să-l dezactivaţi.',
	...
	'DISALLOWED_ALREADY'		=> 'Numele specificat nu poate fi dezactivat. Fie există deja în listă, există în lista cuvintelor cenzurate, fie se potriveşte cu un nume de uzilizator deja prezent.',
