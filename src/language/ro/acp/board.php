...
$lang = array_merge($lang, array(
	...
	'WARNINGS_EXPIRE_EXPLAIN'		=> 'Numărul zilelor ce trebuie să treacă înainte ca avertismentul să expire automat din înregistrarea unui utilizator',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_PM_REPORT_EXPLAIN'	=> 'Dacă este activată această opţiune, utilizatorii au posibilitatea de a raporta un mesaj privat pe care l-au primit sau trimis moderatorilor forumului â€™. Aceste mesaje private vor fi apoi vizibile în Panoul moderatorului.',
	'ALLOW_QUICK_REPLY'			=> 'Permite răspunsuri rapide',
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> 'Această setare defineşte dacă răspunsurile rapide sunt activate sau nu. Dacă setarea este activată, forumurile vor avea opţiunea de răspuns rapid activată.',
	...
	'BOARD_PM_EXPLAIN'			=> 'Activează sau dezactivează mesageria privată pentru toţi utilizatorii.',
));
...
$lang = array_merge($lang, array(
	...
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Calea din directorul rădăcină phpBB, de exemplu. <samp>images/avatars/upload</samp>',
...
$lang = array_merge($lang, array(
	...
	'BUMP_INTERVAL_EXPLAIN'			=> 'Numărul de minute, ore sau zile între ultimul mesaj în subiect şi posibilitatea de a populariza acest subect.',
	...
	'MIN_CHAR_LIMIT_EXPLAIN'		=> 'Numărul minim de caractere pe care utilizatorul trebuie să-l adauge într-un mesaj.',

	'POSTING'						=> 'Publicare',
	'POSTS_PER_PAGE'				=> 'Mesaje pe pagină',
	'QUOTE_DEPTH_LIMIT'				=> 'Numărul maxim de citate în cascadă pe mesaj',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'	=> 'Aceasta determină dacă utilizatorii au acces imediat la forum sau dacă este necesară o confirmare. De asemenea, puteţi dezactiva noile înregistrări.',
	...
	'ACC_DISABLE'				=> 'Dezactivează',
	'ACC_NONE'					=> 'Niciunul',
	'ACC_USER'					=> 'De către utilizator',
//	'ACC_USER_ADMIN'			=> 'Utilizator + administrator',
	...
	'ENABLE_COPPA_EXPLAIN'		=> 'Această opţiune le cere utilizatorilor să declare dacă au 13 ani sau mai mult în confirmitate cu declaraţia U.S. COPPA Act. Dacă această opţiune este dezactivată, atunci grupurile specifice COPPA nu vor mai fi afişate.',
	'MAX_CHARS'					=> 'Max',
	'MIN_CHARS'					=> 'Min',
	...
	'REG_LIMIT_EXPLAIN'			=> 'Numărul de încercări pe care utilizatorul le poate face la codul de confirmare înainte ca sesiunea să fie închisă.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_MANAGEMENT_EXPLAIN'		=> 'Acest modul permite diverse fluxuri ATOM, parsarea oricărui cod BB în mesage pentru a le face citibile în fluxurile externe.',
	...
	'ACP_FEED_OVERALL_FORUMS_EXPLAIN'	=> 'Acest flux afişează ultimele mesaje din toate subiectele forumurilor.',
	'ACP_FEED_OVERALL_FORUMS_LIMIT'		=> 'Numărul de elemente pe pagină ce vor fi afişate în fluxul forumului',

	'ACP_FEED_OVERALL_TOPIC'			=> 'Activare flux din toate subiectele',
	'ACP_FEED_OVERALL_TOPIC_EXPLAIN'	=> 'Activează fluxul “Toate Subiectele”',
	'ACP_FEED_OVERALL_TOPIC_LIMIT'		=> 'Numărul de elemente pe pagină ce vor fi afişate în fluxul subiectelor',
...
$lang = array_merge($lang, array(
  'ACP_VC_SETTINGS_EXPLAIN'				=> 'Aici puteţi selecta şi configura componentele CAPTCHA ce implementează diverse metode pentru a respinge încercările de înregistrare ale aşa numiţilor roboţi de spam.',
	'AVAILABLE_CAPTCHAS'					=> 'Componente disponibile',
	'CAPTCHA_UNAVAILABLE'					=> 'CAPTCHA nu poate fi selectat pentru că nu sunt îndeplinite cerinţele pentru a putea fi folosit.',
	'CAPTCHA_GD'							=> 'GD CAPTCHA',
	'CAPTCHA_GD_3D'							=> 'GD 3D Captcha',

	'CAPTCHA_GD_FOREGROUND_NOISE'	    	=> 'Alarmează GD CAPTCHA în prim plan',
	'CAPTCHA_GD_EXPLAIN'		        	=> 'Foloseşte GD pentru a face un CAPTCHA mai avansat.',
	'CAPTCHA_GD_FOREGROUND_NOISE_EXPLAIN'	=> 'Foloseşte alarmarea în prim plan pentru a face GD bazat CAPTCHA mai puternic.',
	'CAPTCHA_GD_X_GRID'						=> 'GD CAPTCHA fundalul alarmat al axei x',
	'CAPTCHA_GD_X_GRID_EXPLAIN'				=> 'Foloseşte setările mai slabe pentru a face GD bazat pe CAPTCHA mai puternic. 0 va dezactiva alarmarea axei x din fundal.',
	'CAPTCHA_GD_Y_GRID'						=> 'GD CAPTCHA fundalul alarmat al axei y',
	'CAPTCHA_GD_Y_GRID_EXPLAIN'				=> 'Foloseşte setările mai slabe pentru a face GD bazat pe CAPTCHA mai puternic. 0 va dezactiva alarmarea axei y din fundal.',
	'CAPTCHA_GD_WAVE'						=> 'GD CAPTCHA distorsiune gen val',
	'CAPTCHA_GD_WAVE_EXPLAIN'				=> 'Aplică o distorsiune gen val imaginii CAPTCHA.',
	'CAPTCHA_GD_3D_NOISE'					=> 'Adaugă obiecte 3D-noise',
	'CAPTCHA_GD_3D_NOISE_EXPLAIN'			=> 'Adaugă obiecte suplimentare peste litere la imaginea CAPTCHA.',
	...
	'CAPTCHA_NO_GD'							=> 'CAPTCHA fără GD',
	'CAPTCHA_PREVIEW_MSG'					=> 'Schimbările proprii pentru setările confirmării vizuale nu au fost salvate. Aceasta este doar o previzualizare.',
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'Cum va arăta CAPTCHA folosind selecţia curentă.',

	'CAPTCHA_SELECT'						=> 'Componente CAPTCHA instalate',
	'CAPTCHA_SELECT_EXPLAIN'				=> 'Lista include componentele CAPTCHA recunoscute de forum. Elementele gri nu sunt disponibile imediat şi ar putea să necesite configurare înainte de folosire.',
	'CAPTCHA_CONFIGURE'						=> 'Configurare CAPTCHA',
	'CAPTCHA_CONFIGURE_EXPLAIN'				=> 'Schimbă setările pentru CAPTCHA selectat.',
	'CONFIGURE'								=> 'Configurare',
	'CAPTCHA_NO_OPTIONS'					=> 'Această componentă CAPTCHA nu are opţiuni de configurare.',

	'VISUAL_CONFIRM_POST'					=> 'Activează confirmarea vizuală pentru mesajele vizitatorilor',
	'VISUAL_CONFIRM_POST_EXPLAIN'			=> 'Cere utilizatorilor anonimi să introducă un cod aleatoriu potrivit cu o imagine pentru a preveni mesajele în bloc.',
	'VISUAL_CONFIRM_REG'					=> 'Activează confirmarea vizuală pentru înregistrări',
	'VISUAL_CONFIRM_REG_EXPLAIN'			=> 'Cere utilizatorilor noi să introducă un cod aleator care să se potrivească cu o imagine pentru a preveni înregistrările în bloc.',
	'VISUAL_CONFIRM_REFRESH'				=> 'Permite utilizatorilor să reîncarce imaginea de confirmare',
	'VISUAL_CONFIRM_REFRESH_EXPLAIN'		=> 'Permite utilizatorilor să solicite noi coduri de confirmare dacă nu pot rezolva confirmarea vizuală în timpul înregistrării. Anumite componente s-ar putea să nu suporte această opţiune.',
...
$lang = array_merge($lang, array(
	...
	'LOAD_USER_ACTIVITY_EXPLAIN'	=> 'Afişează subiectul/forumul activ în profilele utilizatorilor dar şi în panoul utilizatorului. Este recomandat să dezactivaţi această opţiune pe un forum cu mai mult de un milion de mesaje.',
	...
	'YES_ANON_READ_MARKING_EXPLAIN'	=> 'Păstrează informaţiile de stare citite/necitite pentru vizizatori. Dacă este dezactivată, mesajele vor fi întotdeauna marcate ca şi citite pentru vizitatori.',
	...
	'YES_ONLINE_TRACK_EXPLAIN'		=> 'Afişează informaţiile online pentru utilizatori în profile şi în paginile subiectului.',
...
$lang = array_merge($lang, array(
	...
	'LDAP_PASSWORD_EXPLAIN'			=> 'Lăsaţi necompletat pentru a folosi legătura anonimă. Altfel specificaţi parola pentru utilizatorul de mai sus. Necesar pentru serverele Active Directory. <strong>AVERTISMENT:</strong> Această parola va fi păstrată ca text plin în baza de date, fiind vizibilă tuturor celor care pot accesa baza de date sau care pot vizualiza această pagina de configurare.',
...
$lang = array_merge($lang, array(
	...
	'MAX_LOGIN_ATTEMPTS'			=> 'Numărul maxim de încercări de autentificare',
	'MAX_LOGIN_ATTEMPTS_EXPLAIN'	=> 'Dacă numărul maxim de încercări este depăşit, utilizatorul trebuie să-şi confirme suplimentar autentificarea vizuală (confirmarea vizuală).',
...
$lang = array_merge($lang, array(
	...
	'SMTP_PASSWORD_EXPLAIN'			=> 'Specificaţi o parolă doar dacă serverul SMTP o cere.',
	'SMTP_PLAIN'					=> 'PLAIN',
