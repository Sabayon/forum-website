...
$lang = array_merge($lang, array(
    ...
    'LANGUAGE_ENTRIES'                    => 'Intrări limbă',
    'LANGUAGE_ENTRIES_EXPLAIN'            => 'Aici puteţi schimba intrările pachetelor de limbă existente sau a celor care încă nu au fost traduse.<br /><strong>Reţineţi:</strong> Odată ce aţi schimbat un fişer de limbă, schimbările vor fi stocate într-un director separat pentru a putea fi descărcat. Schimbările nu vor fi vizibile de către utilizatori până nu înlocuiţi fişierele originale de limbă din spaţiul web propriu (prin upload).',
    'LANGUAGE_FILES'                    => 'Fişiere de limbă',
    'LANGUAGE_KEY'                        => 'Chei de limbă',
    ...
    'LANGUAGE_VARIABLE'                    => 'Variabila de limbă',
