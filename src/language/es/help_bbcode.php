...
$help = array(
	...
	array(
		...
		1 => 'Hay dos formas de citar un texto, haciendo o no referencia.<ul><li>Cuando utiliza la función Citar para responder un tema debe de notar que el texto es agregado a la ventana de respuesta encerrado entre las etiquetas <strong>[quote=&quot;&quot;][/quote]</strong>. ¡Este método le permite citar textos haciendo referencia a la persona que lo ha escrito! Por ejemplo para citar un trozo de texto que ha redactado Mr. Blobby debe escribir:<br /><br /><strong>[quote=&quot;Mr. Blobby&quot;]</strong>El texto que redactó Mr. Blobby va aquí<strong>[/quote]</strong><br /><br />El texto resultante añadirá automáticamente, Mr. Blobby escribió: antes del texto actual. Recuerde que <strong>es imprescindible</strong> incluir las comillas &quot;&quot; para encerrar el nombre del usuario citado. No es opcional.</li><li>El segundo método le permite citar un texto ocultando su redactor. Para hacerlo debe encerrar el texto entre las etiquetas <strong>[quote][/quote]</strong>. Cuando vea el mensaje verá que solamente se muestra el mensaje sin hacer referencia al autor.</li></ul>'
	),
	array(
	...
	array(
		...
		1 => 'phpBB BBCode incluye una etiqueta para poder incorporar imágenes en los mensajes. Dos cosas importantes para cuando utilice esta etiqueta son: muchos usuarios no aprecian ver muchas imágenes dentro de un mensaje y, segundo, éstas deben estar disponibles en Internet (no pueden existir solo en su PC, ¡a menos que se trate de un servidor web!). Para publicar una imagen debe encerrar su dirección URL entre las etiquetas <strong>[img][/img]</strong>. Por ejemplo:<br /><br /><strong>[img]</strong>http://www.google.com/intl/en_ALL/images/logo.gif<strong>[/img]</strong><br /><br />También puede incluir la dirección URL de una imagen entre las etiquetas <strong>[url][/url]</strong> si es que así lo desea, ej.<br /><br /><strong>[url=http://www.google.com/][img]</strong>http://www.google.com/intl/en_ALL/images/logo.gif<strong>[/img][/url]</strong><br /><br />se convierte en:<br /><br /><a href="http://www.google.com/"><img src="http://www.google.com/intl/en_ALL/images/logo.gif" alt="" /></a>'
	),
	array(
