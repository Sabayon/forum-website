...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'هنا تستطيع التحكم بالأسماء الممنوعة من الاستعمال. يمكنك أيضاً استخدام العلامة الشاملة (*) في الأسماء. يرجى ملاحظة أنك لن تستطيع تحديد أية اسماء قد تسجلت مسبقا, يجب عليك أولاً حذف هذا الاسم ثم منعه',
	...
	'DISALLOWED_ALREADY'		=> 'الاسم الذي أضفته لا يمكن منعه. قد يكون موجودا سابقاً في اللائحة أو موجود في لائحة مراقبة الكلمات أو أن الاسم مستخدم فعلاً',
