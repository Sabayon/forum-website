...
/**
*
* install [French (Formal Honorifics)]
*
* @package language
...
$lang = array_merge($lang, array(
	...
	'BLANK_PREFIX_FOUND'			=> 'Une vérification de vos tables a détecté une installation valide sans préfixe de table.',
	...
	'COLLIDING_USERNAMES_FOUND'	=> 'Des noms d’utilisateurs similaires ont été trouvés sur votre ancien forum. Afin d’accomplir correctement la conversion, vous devez supprimer ou renommer ces utilisateurs de sorte qu’il n’y ait qu’un seul utilisateur pour chaque nom d’utilisateur propre.',
	...
	'CONTINUE_CONVERT_BODY'		=> 'Une tentative de conversion antérieure a été trouvée. Vous avez à présent le choix de commencer une nouvelle conversion ou de continuer cette conversion.',
	...
	'CONV_ERROR_INCONSISTENT_GROUPS'	=> 'Une contradiction a été détectée dans <var>add_bots()</var> situé dans la table des groupes. Si vous souhaitez le corriger manuellement, n’oubliez pas d’ajouter tous les groupes spéciaux.',
	...
	'COULD_NOT_FIND_PATH'		=> 'Le chemin vers votre ancien forum est introuvable. Veuillez vérifier vos réglages et réessayer.<br />» %s était spécifié comme le chemin d’accès vers la source.',
	...
	'DB_HOST_EXPLAIN'			=> 'Le DSN n’est approprié que pour les installations de type ODBC.',
	'DB_NAME'					=> 'Nom de la base de données',
	'DB_PASSWORD'				=> 'Mot de passe de la base de données',
	'DB_PORT'					=> 'Port du serveur de la base de données',
	'DB_PORT_EXPLAIN'			=> 'Laissez cela vide à moins que vous sachiez que le serveur utilise un port non standard.',
	'DB_UPDATE_NOT_SUPPORTED'	=> 'Nous sommes désolés mais ce script ne prend pas en charge la mise à jour des versions de phpBB antérieures à la “%1$s”. La version que vous avez actuellement installé est la “%2$s”. Veuillez mettre à jour phpBB vers une version plus ancienne avant d’exécuter ce script. Si vous rencontrez des problèmes, n’hésitez pas à demander de l’aide sur les forums de support de phpBB.com ou de phpBB.fr.',
  'DB_USERNAME'				=> 'Nom d’utilisateur de la base de données',
	'DB_TEST'					=> 'Tester la connexion',
	'DEFAULT_LANG'				=> 'Langue par défaut du forum',
	'DEFAULT_PREFIX_IS'			=> 'Le convertisseur n’a pu trouver aucune table avec le préfixe que vous avez spécifié. Veuillez vous assurer d’avoir correctement saisi toutes les informations relatives au forum que vous souhaitez convertir. Le préfixe de la table par défaut pour %1$s est <strong>%2$s</strong>.',
	...
	'FORUM_ADDRESS_EXPLAIN'		=> 'Ceci est le lien de votre ancien forum, par exemple <samp>http://www.example.com/phpBB2/</samp>. Si une adresse est saisie ici et sur la gauche, chaque exemple de cette adresse sera remplacé par l’adresse de votre nouveau forum saisie dans les messages, les messages privés et les signatures.',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<p>En cliquant sur le bouton ci-dessous, vous accéderez à un formulaire permettant d’envoyer des données statistiques à phpBB dans votre panneau de contrôle de l’administrateur (PCA). Nous vous serions reconnaissants si vous pouviez nous aider en envoyant ces données. Après quoi, vous pourrez prendre le temps de consulter toutes les options qui vous sont disponibles. N’oubliez pas que de l’aide en ligne concernant l’utilisation de phpBB est disponible par l’intermédiaire de la <a href="http://www.phpbb.com/support/documentation/3.0/">documentation</a>, du fichier <a href="%3$s">README</a>, des <a href="http://www.phpbb.com/community/viewforum.php?f=46">forums de support officiels</a> et des <a href="http://forum.phpbb.fr/">forums de support francophones</a>.</p><p><strong>Veuillez supprimer, déplacer ou renommer le répertoire d’installation avant d’utiliser votre forum. Tant que ce répertoire existe, vous n’aurez accès qu’au panneau de contrôle de l’administrateur.</strong>',
	...
	<ul>
		...
		<li>SQLite 2.8.2+</li>
		<li>Firebird 2.1+</li>
		<li>MS SQL Server 2000+ (directement ou via ODBC)</li>
		<li>Oracle</li>
	</ul>
	...
	'INSTALL_NEXT_PASS'			=> 'Tous les tests basiques ont été passés avec succès et vous pouvez à présent continuer à l’étape suivante de l’installation. Vous pouvez décider de tester à nouveau dans le cas où vous avez modifié certains modules, permissions, etc.',
	'INSTALL_PANEL'				=> 'Panneau de l’installation',
	'INSTALL_SEND_CONFIG'		=> 'Malheureusement, l’écriture directe des informations nécessaires sur le fichier de configuration a échouée. Il est possible que ce fichier n’existe pas ou qu’il ne soit puisse pas ête écrit. Un certain nombre d’options seront énumérées ci-dessous afin de vous permettre d’accomplir correctement l’installation de ce fichier.',
	'INSTALL_START'				=> 'Commencer l’installation',
	'INSTALL_TEST'				=> 'Retester',
	...
	'INST_ERR_DB_NO_MYSQLI'		=> 'La version de MySQL qui est installée sur votre serveur est incompatible avec l’option “MySQL avec extension MySQLi” que vous avez sélectionné. Veuillez plutôt essayer de sélectionner l’option “MySQL”.',
	...
	'INST_ERR_NO_DB'			=> 'Impossible de charger le module PHP pour le type de base de données que vous avez sélectionné.',
	...
	'MYSQL_SCHEMA_UPDATE_REQUIRED'	=> 'Le schéma de votre base de données MySQL est obsolète. phpBB a détecté un schéma pour MySQL 3.x/4.x, mais le serveur fonctionne avec MySQL %2$s.<br /><strong>Avant de procéder à la mise à jour, vous devez mettre à jour le schéma.</strong><br /><br />Veuillez consulter l’<a href="http://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors/">article de la base de connaissances à propos de la mise à jour du schéma MySQL</a>. Veuillez utiliser <a href="http://www.phpbb.com/community/viewforum.php?f=46">les forums de support officiels</a> ou <a href="http://forum.phpbb.fr/">les forums de support francophones</a> si vous rencontrez des difficultés.',
	...
	'NO_CONVERT_SPECIFIED'		=> 'Aucun convertisseur n’est spécifié.',
	'NO_LOCATION'				=> 'Impossible de déterminer l’emplacement. Si vous savez qu’Imagemagick est installé, vous pouvez spécifier ultérieurement son emplacement dans le panneau de contrôle de l’administrateur.',
	'NO_TABLES_FOUND'			=> 'Aucune table n’a été trouvée.',

	'OVERVIEW_BODY'				=> 'Bienvenue sur phpBB3 !<br /><br />phpBB™ est la solution de création de forums libre et gratuite la plus utilisée dans le monde. phpBB3 est le fruit d’un long travail qui a débuté dans l’année 2000. Tout comme ses prédécesseurs, phpBB3 est riche en fonctionnalités, convivial et entièrement supporté par les équipes de support de phpBB. phpBB3 améliore considérablement ce qui a rendu phpBB2 populaire et ajoute des fonctionnalités qui n’étaient pas présentes dans les précédentes versions. Nous espérons avoir répondu convenablement à vos attentes.<br /><br />Ce système d’installation vous guidera dans l’installation de phpBB3, dans la mise à jour des versions antérieures à la dernière version de phpBB3 et bien évidemment dans la conversion de phpBB3 vers d’autres solutions de forums, comme phpBB2. Pour plus d’informations, nous vous encourageons à consulter <a href="../docs/INSTALL.html">le guide d’installation</a>.<br /><br />Pour consulter la licence de phpBB3 ou en savoir plus sur l’obtention du support ainsi que notre position envers cela, veuillez sélectionner les options appropriées situées sur le menu latéral. Pour continuer, veuillez sélectionner l’onglet approprié ci-dessus.',
	...
	'PHP_GETIMAGESIZE_SUPPORT_EXPLAIN'	=> '<strong>Obligatoire</strong> - afin que phpBB puisse fonctionner correctement, la fonction <var>getimagesize</var> doit être disponible.',
	'PHP_OPTIONAL_MODULE'			=> 'Modules facultatifs',
	'PHP_OPTIONAL_MODULE_EXPLAIN'	=> '<strong>Facultatif</strong> - ces modules ou applications sont facultatifs mais ils permettront l’activation de fonctionnalités supplémentaires s’ils sont disponibles.',
	'PHP_SUPPORTED_DB'				=> 'Bases de données supportées',
	'PHP_SUPPORTED_DB_EXPLAIN'		=> '<strong>Obligatoire</strong> - vous devez avoir au moins une base de données compatible avec PHP. Si aucun module de base de données n’est disponible, vous devriez contacter votre hébergeur ou consulter la documentation appropriée sur l’installation de PHP afin d’en savoir plus.',
	'PHP_REGISTER_GLOBALS'			=> 'Le réglage PHP <var>register_globals</var> est désactivé',
	'PHP_REGISTER_GLOBALS_EXPLAIN'	=> 'phpBB fonctionnera même si ce réglage est activé. Pour des raisons de sécurité, il est cependant recommandé de désactiver <var>register_globals</var> de votre installation PHP.',
	'PHP_SAFE_MODE'					=> 'Mode sécurisé',
	'PHP_SETTINGS'					=> 'Réglages et version de PHP',
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>Obligatoire</strong> - vous devez au moins utiliser la version 4.3.3 de PHP afin d’installer phpBB. Si le <var>mode sécurisé</var> est affiché ci-dessous, votre installation PHP fonctionne sous ce mode. Cela imposera des limitations à l’administration à distance et à des fonctionnalités similaires.',
	'PHP_URL_FOPEN_SUPPORT'			=> 'Le réglage PHP <var>allow_url_fopen</var> est activé',
	'PHP_URL_FOPEN_SUPPORT_EXPLAIN'	=> '<strong>Facultatif</strong> - ce réglage est facultatif mais la fonctionnalité vous permettant d’insérer des avatars à partir de sites externes ne fonctionnera pas correctement sans lui.',
	...
	'SEARCH_INDEX_UNCONVERTED_EXPLAIN'	=> 'Votre ancien index de recherche n’a pas été converti. La recherche retournera toujours un résultat vide. Pour créer un nouvel index de recherche, rendez-vous sur le panneau de contrôle de l’administrateur, cliquez sur <em>Maintenance</em> et sélectionnez l’index de recherche à partir du sous-menu.',
	...
	'STAGE_ADVANCED_EXPLAIN'	=> 'Les réglages de cette page ne sont nécessaires que s’ils diffèrent des réglages par défaut. Si vous avez un doute, ne modifiez pas ces réglages et continuez vers l’étape suivante car ils pourront être modifiés ultérieurement sur le panneau de contrôle de l’administrateur.',
	...
	'UPDATE_TOPICS_POSTED_ERR'	=> 'Une erreur est survenue lors de la création des informations sur les sujets publiés. Vous pouvez recommencer cette étape dans le panneau de contrôle de l’administrateur une fois que la procédure de conversion soit terminée.',
...
$lang = array_merge($lang, array(
	...
	'COMPLETE_LOGIN_TO_BOARD'		=> 'Vous pouvez à présent <a href="../ucp.php?mode=login">vous connecter sur votre forum</a> et vérifier que tout fonctionne correctement. N’oubliez pas de supprimer, de renommer ou de déplacer votre répertoire d’installation !',
	...
	'DOWNLOAD_UPDATE_METHOD_EXPLAIN'	=> 'Une fois téléchargée, vous devez décompresser cette archive. Elle comporte les fichiers modifiés que vous avez à transférer dans votre répertoire situé à la racine de phpBB. Veuillez vous assurer de transférer ces fichiers dans leurs emplacements respectifs et des les revérifier grâce au bouton situé ci-dessous.',
	...
	'FILES_CONFLICT_EXPLAIN'		=> 'Les fichiers suivants ont été modifiés par rapport aux fichiers originaux. Ils ne pourront pas être fusionnés sans provoquer de conflits. Veuillez les vérifier afin de détecter la source des conflits afin de la résoudre manuellement, ou bien continuez la procédure de mise à jour en sélectionnant une méthode de fusion préférentielle. Si vous résolvez les conflits manuellement, vérifiez à nouveau les fichiers une fois les modifications apportées. Vous pouvez également sélectionner une des deux méthodes de fusion pour chaque fichier. La première produira un fichier où les lignes conflictuelles de votre ancien fichier seront perdues et l’autre ignorera toute modification apportée au nouveau fichier.',
	...
	'OLD_UPDATE_FILES'		=> 'Les fichiers de mise à jour sont obsolètes. Les fichiers de mise à jour sont à exécuter afin d’effectuer la mise à jour de phpBB %1$s vers phpBB %2$s mais la dernière version est phpBB %3$s.',
	...
	'SOME_QUERIES_FAILED'		=> 'Certaines requêtes ont échoué, les erreurs et les instructions sont listées ci-dessous.',
	'SQL'						=> 'SQL',
	...
	'TRY_DOWNLOAD_METHOD'      => 'Vous devriez essayer la méthode de téléchargement des fichiers modifiés.<br />Cette méthode marche toujours et est également la plus recommandée afin de mettre votre forum à jour.',
  'TRY_DOWNLOAD_METHOD_BUTTON'=> 'Essayer maintenant cette méthode',
	...
	'UPDATE_SUCCESS_EXPLAIN'		=> 'Tous les fichiers ont été mis à jour avec succès. La prochaine étape consiste à revérifier tous les répertoires afin de vous assurer que les fichiers ont été correctement mis à jour.',
