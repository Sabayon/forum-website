...
$lang = array_merge($lang, array(
	...
	'DELETE_IMAGESET_EXPLAIN'	=> 'Vous pouvez supprimer ici l’archive d’images que vous avez sélectionné. Si vous en avez la permission, vous pourrez également choisir de supprimer l’archive du système de fichiers. Veuillez noter qu’il n’y a pas de retour en arrière possible, quand l’archive d’images est supprimée, elle le sera pour toujours. Il est recommandé d’exporter d’abord votre archive pour une possible utilisation future.',
