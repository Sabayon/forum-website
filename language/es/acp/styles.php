...
$lang = array_merge($lang, array(
	...
	'DELETE_IMAGESET_EXPLAIN'		=> 'Aquí puede eliminar el paquete de imágenes seleccionado de la base de datos. Además, si tiene los permisos puede elegir borrar el paquete del sistema. Por favor observe que no se puede deshacer. Cuando borra un paquete, se elimina de forma total. Es recomendable que primero lo exporte para usarlo en el futuro.',
	...
	'DELETE_TEMPLATE_EXPLAIN'		=> 'Aquí puede eliminar la plantilla seleccionada de la base de datos. Además, si tiene los permisos puede elegir borrar la plantilla del sistema. Por favor observe que no se puede deshacer. Cuando borra una plantilla, se elimina de forma completa. Es recomendable que primero lo exporte para usarlo en el futuro.',
	'DELETE_THEME'					=> 'Borrar tema',
	'DELETE_THEME_EXPLAIN'			=> 'Aquí puede eliminar el tema seleccionado de la base de datos. Además, si tiene los permisos puede elegir borrar el tema del sistema. Por favor observe que no se puede deshacer. Cuando borra un tema, se elimina de forma completa. Es recomendable que primero lo exporte para usarlo en el futuro.',
	'DETAILS'						=> 'Detalles',
