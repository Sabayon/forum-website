...
$lang = array_merge($lang, array(
	...
	'CONFIRM_CODE_EXPLAIN'	=> 'Introduzca el código exactamente como lo ve en la imagen, no es sensible a mayúsculas. Por favor tenga en cuenta que el cero no existe aquí.',
	...
	'LOGIN_CONFIRM_EXPLAIN'	=> 'Para prevenir el forzado de cuentas La Administración del Sitio requiere que introduzca un código de confirmación después de una cantidad máxima de identificaciones fallidas. El código se muestra en la imagen que debería ver debajo. Si está impedido visualmente o por cualquier motivo no puede leer ese código por favor contacte con %sLa Administración del Sitio%s.',
	'LOGIN_ERROR_ATTEMPTS'	=> 'Ha excedido el número máximo permitido de intentos de identificarse. Además de su nombre de usuario y contraseña ahora deberá introducir el código de confirmación de la imagen que ve debajo.',
