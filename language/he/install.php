...
$lang = array_merge($lang, array(
	...
	'DB_HOST_EXPLAIN'			=> 'DSN הינו שם מקור הנתונים ומתאים להתקני ODBC בלבד.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'כל הקבצים מעודכנים לגרסה האחרונה של phpBB. אתה צריך כעת <a href="../ucp.php?mode=login&amp;redirect=adm/index.php%3Fi=send_statistics%26mode=send_statistics">להתחבר לפורום שלך</a> ולבדוק אם הכל עובד כשורה. אל תשכח למחוק, לשנות שם או להעביר את תיקית ההתקנה!  אנא שלח לנו מידע מעודכן על הגדרות השרת והמערכת מעמוד <a href="../ucp.php?mode=login&amp;redirect=adm/index.php%3Fi=send_statistics%26mode=send_statistics">מידע סטטיסטי</a> בלוח הבקרה למנהלים ראשיים.',
	...
	'SOME_QUERIES_FAILED'		=> 'כמה שאילתות נכשלו, המשפטים והשגיאות רשומים להלן.',
	'SQL'						=> 'SQL',
...
$lang = array_merge($lang, array(
	...
	'DEFAULT_INSTALL_POST'			=> 'זוהי הודעת הדגמה בהתקנת phpBB3. הכל נראה כעובד כשורה. אתה רשאי למחוק את הודעה זו אם אתה רוצה להמשיך להגדיר את המערכת. במהלך תהליך ההתקנה הקטגוריה הראשונה והפורום הראשון נוצרו והרשאות מתאימות לקבוצות המנהלים הראשיים, הבוטים, המנהלים הגלובאלים, האורחים ומשתמשים רשומים. אם אתה רוצה גם למחוק את הקטגוריה הראשונה והפורום הראשון, אל תשכח להעניק הרשאות לכל קבוצות המשתמשים הללו לכל הקטגוריות החדשות והפורומים שאתה תצור. מומלץ לשנות את השם של הקטגוריה הראשונה והפורום הראשון ולהעתיק את ההרשאות מהם שאתה יוצר קטגוריות חדשות ופורומים חדשים. תהנה!',

	'EXT_GROUP_ARCHIVES'			=> 'ארכיונים',
	'EXT_GROUP_DOCUMENTS'			=> 'מסמכים',
	'EXT_GROUP_DOWNLOADABLE_FILES'	=> 'קבצים הניתנים להורדה',
	'EXT_GROUP_FLASH_FILES'			=> 'קבצי Flash',
	'EXT_GROUP_IMAGES'				=> 'תמונות',
	'EXT_GROUP_PLAIN_TEXT'			=> 'טקסט פשוט',
	'EXT_GROUP_QUICKTIME_MEDIA'		=> 'מדיית Quicktime',
	'EXT_GROUP_REAL_MEDIA'			=> 'מדיית Real',
	'EXT_GROUP_WINDOWS_MEDIA'		=> 'מדיית Windows',
