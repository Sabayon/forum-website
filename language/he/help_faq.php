...
$help = array(
	...
	array(
		...
		1 => 'לא מצליח לאתר את כתובת הדואר האלקטרוני שהזנת, בדוק את שם המשתמש והסיסמה ונסה שנית. יכול להיות שמנהלי המערכת ביטלו את חשבונך או הסירו אותו מן המערכת. בנוסף, יכול להיות שהמערכת הסירה משתמשים אשר לא היו פעילים זמן רב. במידה וזה אכן קרה, נסה להרשם שוב, ותיהיה יותר פעיל בדיונים.'
	),
	array(
		0 => 'מהו COPPA?',
	...
	array(
		...
		1 => 'אם אתה משתמש רשום, כל הגדרותיך שמורות במסד הנתונים. בכדי לשנותם, בקר בלוח הבקרה למשתמש; את הקישור לדף זה תוכל למצוא בראש הדף. מערכת זו תאפשר לך לשנות את ההגדרות והאפשרויות האישיות שלך.'
	),
	array(
	...
	array(
		0 => 'איך אני מציג תמונה מתחת לשם המשתמש שלי?',
		1 => 'ישנם שני סוגי תמונות אשר מופיעות בהודעות המשתמש. תלוי בסוג העיצוב, הראשונה היא התמונה שמראה את דירוג המשתמש, לרוב בסגנון כוכבים, או נקודות, תלוי בכמות ההודעות שנשלחה במערכת הפורומים. השניה, לרוב תמונה יותר גדולה, זהו הסמל האישי והוא בדר"כ שונה ממשתמש למשתמש. לרוב גודל הסמל אישי תלוי ונתון להחלטת מנהלי המערכת. אם אינך מצליח להשתמש בסמל האישי, צור קשר עם מנהלע המערכת ושאל את סיבותיהם לדחיית אפשרות זו.'
	),
	array(
