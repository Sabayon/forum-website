...
$lang = array_merge($lang, array(
	...
	'ENABLE_QUICK_REPLY_EXPLAIN'	=> 'אם תגדיר לכן משתמשים יראו תיבת תגובה מהירה בפורום זה. אם ההגדרה הגלובאלית לתגובה מהירה מבוטלת או שהפורום לא ניתן לכתיבה תיבת התגובה המהירה לא תוצג, גם אם תגדיר כאן כן.',
	...
	'FORUM_ADMIN_EXPLAIN'				=> 'במערכת phpBB3 אין קטגוריות, הכל פועל על בסיס פורומים. כל פורום לא מוגבל במספר תתי-הפורומים שלו ואתה יכול להחליט אם לאפשר שליחת הודעות או לא. כאן אתה יכול להוסיף, לערוך, למחוק, לנעול, לאפשר נעילות ולהגדיר אפשרויות נוספות אחרות בכל פורום ופורום. אם תרצה בכך, תוכל גם תמיד לאפס כל פורום ובכך למחוק נושאים והודעות שהתיישנו, וזאת לפי קריטריונים שתבחר.<strong>על מנת שפורומים חדשים שנוצרו יוצגו, עליך קודם להעתיק או לקבוע הרשאות חדשות מתאימות בעבורם.</strong>',
	'FORUM_ADMIN_EXPLAIN'				=> 'במערכת phpBB3 אין קטגוריות, הכל פועל על בסיס פורומים. כל פורום לא מוגבל במספר תתי-הפורומים שלו ואתה יכול להחליט אם לאפשר שליחת הודעות או לא. כאן אתה יכול להוסיף, לערוך, למחוק, לנעול, לאפשר נעילות ולהגדיר אפשרויות נוספות אחרות בכל פורום ופורום. אם תרצה בכך, תוכל גם תמיד לאפס כל פורום ובכך למחוק נושאים והודעות שהתיישנו, וזאת לפי קריטריונים שתבחר.<strong>על מנת שפורומים חדשים שנוצרו יוצגו, עליך קודם להעתיק או לקבוע הרשאות חדשות מתאימות בעבורם.</strong>',
	...
	'FORUM_PASSWORD_OLD'				=> 'סיסמת הפורום משתמשת בהצפנה הישנה וצריכה להשתנות.',
