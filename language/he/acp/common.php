...
$lang = array_merge($lang, array(
	...
	'ACP_ADMIN_ROLES'			=> 'כללי מנהלים ראשיים',
	...
	'ACP_PERMISSION_ROLES'		=> 'כללי הרשאה',
	...
	'ACP_USER_RANK'					=> 'דירוג',
	'ACP_USER_ROLES'				=> 'כללי משתמשים',
	'ACP_USER_SECURITY'				=> 'אבטחת משתמשים',
	'ACP_USER_SIG'					=> 'חתימה',

	'ACP_USER_WARNINGS'				=> 'אזהרות',

	'ACP_VC_SETTINGS'					=> 'הגדרות מודול CAPTCHA',
...
$lang = array_merge($lang, array(
	...
	'LOG_CONFIG_VISUAL'			=> '<strong>שינה הגדרות אימות חזותי</strong>',

	'LOG_APPROVE_TOPIC'			=> '<strong>אישר נושא</strong><br />» %s',
	'LOG_BUMP_TOPIC'			=> '<strong>משתמש הבליט נושא</strong><br />» %s',
	...
	'LOG_FORK'					=> '<strong>העתיק נושא</strong><br />» from %s',
	...
	'LOG_A_ROLE_ADD'		=> '<strong>כלל מנהל ראשי נוסף</strong><br />» %s',
	'LOG_A_ROLE_EDIT'		=> '<strong>כלל מנהל ראשי נערך</strong><br />» %s',
	'LOG_A_ROLE_REMOVED'	=> '<strong>כלל מנהל ראשי הוסר</strong><br />» %s',
	'LOG_F_ROLE_ADD'		=> '<strong>כלל פורום נוסף</strong><br />» %s',
	'LOG_F_ROLE_EDIT'		=> '<strong>כלל פורום נערך</strong><br />» %s',
	'LOG_F_ROLE_REMOVED'	=> '<strong>כלל פורום הוסר</strong><br />» %s',
	'LOG_M_ROLE_ADD'		=> '<strong>כלל מנהל נוסף</strong><br />» %s',
	'LOG_M_ROLE_EDIT'		=> '<strong>כלל מנהל נערך</strong><br />» %s',
	'LOG_M_ROLE_REMOVED'	=> '<strong>כלל מנהל הוסר</strong><br />» %s',
	'LOG_U_ROLE_ADD'		=> '<strong>כלל משתמש נוסף</strong><br />» %s',
	'LOG_U_ROLE_EDIT'		=> '<strong>כלל משתמש נערך</strong><br />» %s',
	'LOG_U_ROLE_REMOVED'	=> '<strong>כלל משתמש הוסר</strong><br />» %s',
