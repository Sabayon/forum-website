...
$lang = array_merge($lang, array(
	...
	'ACP_FEED'					=> 'إدارة التغذية Feed',
	'ACP_FEED_SETTINGS'			=> 'إعدادات التغذية Feed',
	...
	'ADM_LOGOUT'         	=> 'لوحة التحكم&nbsp;خروج من',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'هذه لائحة بآخر 10 أعضاء مسلجين لم يفعلوا عضوياتهم، اللائحة الكاملة يمكن الوصول إليها من القائمة المناسبة أو بالضغط على الرابط أدناه حيث يمكنك تفعيل هذه العضويات أو حذفها أو تذكير هؤلاء الأعضاء (عن طريق ارسال بريد) إذا أردت ذلك',
...
$lang = array_merge($lang, array(
	...
	'LOG_WARNINGS_DELETED'		=> '<strong>حذف عدد %2$s تحذيرات للعضو</strong><br />» %1$s', // Example: '<strong>Deleted 2 user warnings</strong><br />» username'
