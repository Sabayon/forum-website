...
$lang = array_merge($lang, array(
	...
	'CHECK_CONTENT_EXPLAIN'		=> 'بعض المتصفحات يمكن خداعها في الحد الأعلى لحجم رفع الملفات ، هذا الخيار للتأكد من اخطاء كهذه ستبطَل',
	...
	'UPLOAD_DIR_EXPLAIN'			=> 'مجلد تخزين المرفقات ، يجب مراعاة أنك إن تغيرت هذا المجلد ينبغي عليك نقل الملفات المرفقة مسبقاً يدوياً للمجلد الجديد',
