...
$lang = array_merge($lang, array(
	...
	'ALREADY_REPORTED'		=> 'لقد بُلِّغ عن هذه المشاركة من قبل',
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'باستخدام النموذج أدناه يمكنك دمج المشاركات المحددة إلى موضوع آخر، هذه المشاركات لن يعاد تسجيلها وستظهر وكأن الأعضاء قد كتبوها في الموضوع الجديد.<br />يرجى منك إدخال رقم الموضوع المطلوب أو اضغط على "اختر موضوع" للبحث عن أحدها',
