<?php
/**
* acp_permissions (phpBB Permission Set) [Greek - El]
*
* @package language
...
$lang = array_merge($lang, array(
	...
	'acl_u_attach'		=> array('lang' => 'Μπορεί συνημμένα αρχεία', 'cat' => 'post'),
	...
	'acl_u_masspm'      => array('lang' => 'Μπορεί να στείλει μηνύματα σε πολλά μέλη', 'cat' => 'pm'),
    'acl_u_masspm_group'=> array('lang' => 'Μπορεί να στείλει μηνύματα σε ομάδες μελών', 'cat' => 'pm'),
	...
	'acl_u_pm_bbcode'	=> array('lang' => 'Μπορεί να δημοσιεύσει BBCode στα προσωπικά μηνύματα', 'cat' => 'pm'),
	'acl_u_pm_smilies'	=> array('lang' => 'Μπορεί να δημοσιεύσει εικονίδια στα προσωπικά μηνύματα', 'cat' => 'pm'),
	'acl_u_pm_img'		=> array('lang' => 'Μπορεί να δημοσιεύσει εικόνες στα προσωπικά μηνύματα', 'cat' => 'pm'),
	'acl_u_pm_flash'	=> array('lang' => 'Μπορεί να δημοσιεύσει Flash στα προσωπικά μηνύματα', 'cat' => 'pm'),
...
$lang = array_merge($lang, array(
	...
	'acl_f_smilies'		=> array('lang' => 'Μπορεί να δημοσιεύσει εικονίδια', 'cat' => 'content'),
	'acl_f_img'			=> array('lang' => 'Μπορεί να δημοσιεύσει εικόνες', 'cat' => 'content'),
	'acl_f_flash'		=> array('lang' => 'Μπορεί να δημοσιεύσει Flash', 'cat' => 'content'),
