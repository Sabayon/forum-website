...
$lang = array_merge($lang, array(
	'NO_VALID_USERS'				=> 'Δεν έχετε εισαγάγει κάποιο χρήστη για αυτή την ενέργεια',
	...
	'GROUP_LEGEND'					=> 'Προβολή ομάδας στην λεζάντα',
	...
	'GROUP_MAX_RECIPIENTS'          => 'Μέγιστος επιτρεπόμενος αριθμός παραληπτών ανά προσωπικό μήνυμα',
    'GROUP_MAX_RECIPIENTS_EXPLAIN'  => 'Ο μέγιστος επιτρεπτός αριθμός παραληπτών σε ένα προσωπικό μήνυμα. Αν εισάγετε 0, τότε θα χρησιμοποιηθεί η γενική ρύθμιση του φόρουμ.',
