...
$lang = array_merge($lang, array(
	'SMILIE_NO_CODE'	=> 'Το εικονίδιο “%s”  αγνοήθηκε, καθώς δεν υπάρχει εισαχθεί κάποιος κώδικας',
	'SMILIE_NO_EMOTION'	=> 'Το εικονίδιο “%s” αγνοήθηκε, καθώς δεν υπάρχει εισαχθεί κάποια κίνηση.',
	...
	'BBCODE_HELPLINE_TOO_LONG'  => 'Η γραμμή βοήθειας που εισάγατε είναι πολύ μεγάλη.',
	...
	'tokens'	=> array(
		'TEXT'	=> 'Κάθε κείμενο, συμπεριλαμβανομένων  ξένων χαρακτήρων, αριθμών, κ.λπ… Δεν πρέπει να χρησιμοποιήσετε αυτό το σημείο στις ετικέττες HTML. Αντί αυτού προσπαθήστε να χρησιμοποιήσετε το ΣΤΟΙΧΕΙΟ ΑΝΑΓΝΩΡΙΣΗΣ  ή ΑΠΛΟ ΚΕΙΜΕΝΟ.',
		'SIMPLETEXT'	=> 'Χαρακτήρες του λατινικού αλφαβήτου (A-Z), αριθμοί, διαστήματα, κόμμα, τελείες, σύμβολα πλην και συν, παύλες και   χαρακτήρες υπογράμισης',
		'IDENTIFIER'	=> 'Χαρακτήρες του λατινικού αλφαβήτου (A-Z), αριθμοί, παύλες και   χαρακτήρες υπογράμισης',
	...
	'ACP_WORDS_EXPLAIN'	=> 'Από αυτήν την επιτροπή ελέγχου μπορείτε να προσθέσετε, να επεξεργαστείτε και να αφαιρέσετε τις λέξεις που θα λογοκριθούν αυτόματα στις Δ. Συζητήσεις σας. Επιπλέον χρήστες έχουν την άδεια να καταχωρήσουν ονόματα μελών που περιέχουν αυτές τις λέξεις. Μπορείτε να εισάγετε και χαρακτήρες μπαλαντέρ (*) στο πεδίο κειμένου. πχ., αν βάλετε *test* θα ταιριάζει το detestable, test* θα ταιριάζει το testing, *test θα τεριάζει το detest.',
