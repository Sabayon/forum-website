...
$lang = array_merge($lang, array(
	'CHECK_CONTENT'	=> 'Ελεγχος συνημμένων αρχείων',
	'CHECK_CONTENT_EXPLAIN'	=> 'Μερικοί περιηγητές (browsers) μπορούν να ξεγελαστούν για να αναγνωρίσουν ένα ανακριβές mimetype για τα αρχεία που ανεβάζεται. Αυτή η επιλογή εξασφαλίζει ότι τέτοια αρχεία που είναι πιθανό να προκαλέσουν αυτό απορρίπτονται.',
	...
	'ATTACH_MAX_PM_FILESIZE_EXPLAIN'	=> 'Μέγιστο μέγεθος κάθε συννημένου αρχείου, βάζοντας 0 δεν υπάρχει όριο, που προσαρτάται σε ένα προσωπικό μήνυμα.',
	...
	'MAX_ATTACHMENTS_PM'			=> 'Μέγιστος αριθμός Συνημμένων ανά μήνυμα',
	...
	'SECURE_DOWNLOAD_UPDATE_SUCCESS'=> 'Η λίστα IP ενημερώθηκε με επιτυχία.',
	'SECURE_EMPTY_REFERRER'			=> 'Επιτρέψτε κενό Αναφορέα',
	'SECURE_EMPTY_REFERRER_EXPLAIN'	=> 'Οι Ασφαλείς Μεταφορτώσεις βασίζονται στους Αναφορείς. Θέλετε να επιτρέψετε τις μεταφορτώσεις σε αυτούς που δεν συγκαταλέγονται σε αυτούς;',
