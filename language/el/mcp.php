...
$lang = array_merge($lang, array(
	...
	'LATEST_UNAPPROVED'			=> 'Τελευταιες 5 που περιμενουν εγκριση',
	...
	'LOGVIEW_VIEWTOPIC'			=> 'Προβολη θεματος',
	...
	'MCP_MAIN_TOPIC_VIEW'			=> 'Προβολη θεματος',
	...
	'MCP_REPORTS'					=> 'Αναφερόμενες δημοσιεύσεις',
 ...
 'Το επιλεγμένο θέμα μετακινήθηκε',
	...
	'REPORT_MESSAGE_EXPLAIN'	=> 'Χρησιμοποιήστε αυτήν την φόρμα για να αναφέρετε το επιλεγμένο μήνυμα. Η υποβολή αναφοράς πρέπει γενικά να χρησιμοποιηθεί μόνο εάν το μήνυμα παραβαίνει τους κανόνες της Δ. Συζήτησης.',
	...
	'RETURN_NEW_FORUM'			=> '%sΕπιστροφή στη νέα Δ. Συζήτηση%s',
	'RETURN_NEW_TOPIC'			=> '%sΕπιστροφή στο νέο θέμα%s',
	...
	'SPLIT_AFTER'						=> 'Διάσπαση δημοσίευσης από το επιλεγμενο θέμα και προς τα εμπρός',
	...
	'report_reasons'		=> array(
		...
		'DESCRIPTION' => array(
			'WAREZ'		=> 'Η αναφερόμενη δημοσίευση περιέχει συνδέσμους με παράνομο λογισμικό.',
			'SPAM'		=> 'Η αναφερόμενη δημοσίευση έχει το μόνο σκοπό να διαφημίσει άλλη ιστοσελίδα ή ένα άλλο προϊόν.',
			'OFF_TOPIC'	=> 'Η αναφερόμενη δημοσίευση είναι εκτός θέματος.',
			'OTHER'		=> 'Η αναφερόμενη δημοσίευση δεν ταιριάζει με αυτήν την κατηγορία , παρακαλώ χρησιμοποιήστε την περαιτέρω φόρμα περιγραφής.',
		)
	),
));
