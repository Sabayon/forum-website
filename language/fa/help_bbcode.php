...
$help = array(
	...
	array(
		0 => 'BBCode چيست ؟',
		1 => 'BBCode ها کدهايي از گروه HTML هستند که در انجمن ها (فروم ها) کاربرد دارند و امکانات جديدي به شما در ارسال مي دهند.به عنوان مثال امکان نقل قول،تغيير رنگ و....'
	),
	array(
		0 => '--',
		1 => 'حالت متني'
	...
	array(
		0 => 'چطور يک متن پررنگ،زير خط دار يا کج بنويسيم ؟',
	...
	array(
		0 => 'چطور رنگ يا اندازه متن را تغيير دهيم ؟',
	...
	array(
		0 => 'آيا مي توان چند دستور را باهم بکار برد ؟',
	...
	array(
		0 => '--',
		1 => 'اضافه کردن عکس به پست'
	),
	array(
		0 => 'اضافه کردن عکس به پست',
	...
	array(
		0 => 'آيا من مي توانم BBcode جديد اضافه کنم ؟',
		1 => 'بله.مديران و موسسان از قسمت مديريت مي توانند.'
	)
);
