...
$lang = array_merge($lang, array(
	...
	'ALLOW_ATTACHMENTS'			=> 'Abilita gli allegati',
 	...
 	'ALLOW_BIRTHDAYS_EXPLAIN'	=> 'Dà la possibilità di inserire la data del compleanno e di visualizzare l’età nel profilo utente. Nota Bene: questa impostazione non è quella che controlla la visualizzazione della lista compleanni nell’indice.',
    ...
    'ALLOW_QUICK_REPLY_EXPLAIN' => 'Questa impostazione determina se la risposta rapida è abilitata o meno. Anche questa impostazione è abilitata i vari forum devono avere a loro volta la loro opzione "risposta rapida" abilitata.',
...
$lang = array_merge($lang, array(
    ...
    'ALLOW_REMOTE_UPLOAD_EXPLAIN'   => 'Abilita la pobbilità di caricare gli avatar memorizzati su un altro sito web.',
...
//	'ACC_USER_ADMIN'			=> 'Utente + Amministratore',
    ...
    $lang = array_merge($lang, array(
       ...
       'ACP_FEED_OVERALL_FORUMS_LIMIT'      => 'Numero di voci Feed per pagina da visualizzare nei forum',

       'ACP_FEED_OVERALL_TOPIC'         => 'Abilita globalmente i Feed negli argomenti',
       'ACP_FEED_OVERALL_TOPIC_EXPLAIN'   => 'Abilita globalmente i Feed per "Tutti gli argomenti".',
       'ACP_FEED_OVERALL_TOPIC_LIMIT'      => 'Numero di voci Feed per pagina da visualizzare negli argomenti',
       ...
       'ACP_FEED_ITEM_STATISTICS_EXPLAIN'   => 'Visualizza le statistiche individuali sotto le voci Feed<br />(A cura di, Data e ora, Risposte, Visite).',
...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'               => 'Qui puoi selezionare e configurare i plugin CAPTCHA (codice di conferma visuale), che attuano vari modi di contrastare i tentativi di registrazione dai cosiddetti spambot.',
    'AVAILABLE_CAPTCHAS'                    => 'Plugin disponibili',
    'CAPTCHA_UNAVAILABLE'                   => 'Il CAPTCHA non può essere selezionato in quanto non si hanno i requisiti adatti, oppure perchè non è stato ancora configurato.',
    ...
    'CAPTCHA_GD_WAVE'						=> 'GD disturbo ondulatorio del Codice Conferma Visuale',
    'CAPTCHA_GD_WAVE_EXPLAIN'				=> 'Usa GD per applicare una distorsione ondulatoria al Codice Conferma Visuale.',
	...
	'CAPTCHA_NO_GD'                         => 'CAPTCHA senza GD',
	...
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'Ecco il Codice di Conferma Visuale come si presenta usando le impostazioni correnti.',
	
	'CAPTCHA_SELECT'                        => 'Plugin CAPTCHA installati',
    'CAPTCHA_SELECT_EXPLAIN'                => 'Nel menu a discesa sono elencati i plugin CAPTCHA riconosciuti dalla board. I nomi in grigio non sono al momento disponibili e potrebbero richiedere una configurazione prima del loro utilizzo.',
    'CAPTCHA_CONFIGURE'                     => 'Configura i CAPTCHA',
    'CAPTCHA_CONFIGURE_EXPLAIN'				=> 'Modifica le impostazioni per il CAPTCHA selezionato.',
	'CONFIGURE'                             => 'Configura',
    'CAPTCHA_NO_OPTIONS'                    => 'Questo CAPTCHA non ha opzioni di configurazione.',
